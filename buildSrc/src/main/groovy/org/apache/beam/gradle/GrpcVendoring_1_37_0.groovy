...
class GrpcVendoring_1_37_0 {
  ...
  // google-auth-library version from https://search.maven.org/artifact/io.grpc/grpc-auth/1.37.0/jar
  static def google_auth_version = "0.22.2"
  // proto-google-common-protos version from https://search.maven.org/artifact/io.grpc/grpc-protobuf/1.37.0/jar
