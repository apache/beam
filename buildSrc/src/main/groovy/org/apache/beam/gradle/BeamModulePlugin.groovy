  ...
  void apply(Project project) {
    ...
    project.ext.library = [
      java : [
        ...
        google_cloud_pubsub                         : "com.google.cloud:google-cloud-pubsub:1.111.0-sp.3", // google_cloud_platform_libraries_bom sets version
        ...
        google_cloud_spanner                        : "com.google.cloud:google-cloud-spanner:6.4.4-sp.8", // google_cloud_platform_libraries_bom sets version
