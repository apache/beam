  ...
  void apply(Project project) {
    ...
    project.ext.library = [
      java : [
        ...
        // Note that the SnakeYaml 2.0 requires  jackson-dataformat-yaml 2.15 and above (https://github.com/apache/beam/issues/26743)
        snake_yaml                                  : "org.yaml:snakeyaml:2.0",
