...
"""
  ...
  void apply(Project project) {
    ...
    // Enable when 'enableJacocoReport' project property is specified
    ...
    project.gradle.taskGraph.whenReady { graph ->
      ...
      def enabled = project.hasProperty('enableJacocoReport') || graph.allTasks.any { it instanceof JacocoReport }
