...
''')
    ...
    project.ext.applyPortabilityNature = {
      ...
      project.protobuf {
        protoc {
          // The artifact spec for the Protobuf Compiler
          artifact = "com.google.protobuf:protoc:${GrpcVendoring_1_35_0.protobuf_version}" }
        ...
        plugins {
          ...
          // the identifier, which can be referred to in the "plugins"
          // container of the "generateProtoTasks" closure.
          grpc { artifact = "io.grpc:protoc-gen-grpc-java:${GrpcVendoring_1_35_0.grpc_version}" }
        }
      ...
      project.dependencies GrpcVendoring_1_35_0.dependenciesClosure() << { shadow project.ext.library.java.vendored_grpc_1_26_0 }
    }
