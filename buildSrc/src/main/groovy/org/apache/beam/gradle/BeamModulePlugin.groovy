...
"""
  ...
  void apply(Project project) {
    ...
    // This version is only used for test classifier artifacts. The main google-cloud-spanner
    // library version is managed by google_cloud_platform_libraries_bom.
