  ...
  void apply(Project project) {
    ...
    project.ext.library = [
      java : [
        ...
        google_auth_library_credentials             : "com.google.auth:google-auth-library-credentials:1.12.2",
        google_auth_library_oauth2_http             : "com.google.auth:google-auth-library-oauth2-http:1.12.2",
