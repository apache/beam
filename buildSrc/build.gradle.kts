...
dependencies {
  ...
  implementation("com.gradleup.shadow:shadow-gradle-plugin:8.3.8") {                   // Enable shading Java dependencies
    exclude(group="org.codehaus.plexus", module="plexus-xml") // Do not bump to plexus-xml 4.x which requires Java17
  }
  runtimeOnly("org.codehaus.plexus:plexus-xml:3.0.2") // plexus-xml 4.x requires Java17
