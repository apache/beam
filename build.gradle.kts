...
tasks.register("pythonLintPreCommit") {
  // TODO(Issue 20209): Find a better way to specify lint and formatter tasks without hardcoding py version.
...
tasks.register("whitespacePreCommit") {
  // TODO(Issue 20209): Find a better way to specify the tasks without hardcoding py version.
