...
project(":playground:frontend:playground_components:tools:extract_symbols_java").projectDir = file("playground/frontend/playground_components/tools/extract_symbols_java")
