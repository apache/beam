...
include(":beam-test-infra-pipelines:dataflow-to-bigquery")
project(":beam-test-infra-pipelines:dataflow-to-bigquery").projectDir = file(".test-infra/pipelines/dataflow-to-bigquery")
