...
public class WinningBids extends PTransform<PCollection<Event>, PCollection<AuctionBid>> {
  ...
  private static class AuctionOrBidWindow extends IntervalWindow implements Serializable {
    ...
    public static AuctionOrBidWindow forBid(
      ...
      // and assuming the system is running at its lowest qps (as per interEventDelayUs).
  ...
  private static class AuctionOrBidWindowFn extends WindowFn<Event, AuctionOrBidWindow> {
    ...
    private static final OutputTimeFn.DependsOnlyOnWindow<AuctionOrBidWindow> OUTPUT_TIME_FN =
        new OutputTimeFn.DependsOnlyOnWindow<AuctionOrBidWindow>() {
          @Override
          protected Instant assignOutputTime(AuctionOrBidWindow window) {
     ...
     */
    @Override
    public OutputTimeFn<AuctionOrBidWindow> getOutputTimeFn() {
      return OUTPUT_TIME_FN;
    }
  }
  ...
  public WinningBids(String name, NexmarkConfiguration configuration) {
    super(name);
    // What's the expected auction time (when the system is running at the lowest qps).
    long[] interEventDelayUs = configuration.qpsShape.interEventDelayUs(
    ...
    NexmarkUtils.console(null, "Expected auction duration is %d ms", expectedAuctionDurationMs);
