 ...
 */
public class BeamSqlGreaterThanEqualExpression extends BeamSqlCompareExpression {

  public BeamSqlGreaterThanEqualExpression(List<BeamSqlExpression> operands) {
    super(operands);
  }
