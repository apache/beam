    ...
    switch (op.getOutputType()) {
      ...
      case BIGINT:
        result = BeamSqlPrimitive
            .of(SqlTypeName.DOUBLE, SqlFunctions.log10(SqlFunctions.toLong(op.getValue())));
        break;
      case FLOAT:
      case DOUBLE:
        result = BeamSqlPrimitive
      ...
      case DECIMAL:
        result = BeamSqlPrimitive
            .of(SqlTypeName.DOUBLE, SqlFunctions.log10(SqlFunctions.toBigDecimal(op.getValue())));
        break;
    }
    return result;
  }
