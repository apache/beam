 ...
 */
package org.apache.beam.sdk.extensions.gcp.transforms;
...
import org.apache.beam.sdk.extensions.gcp.util.GcpHsmGeneratedSecret;
import org.apache.beam.sdk.extensions.gcp.util.GcpSecret;
...
/** Tests for {@link GroupByEncryptedKey} and GBEK pipeline options using GCP Secrets. */
@RunWith(JUnit4.class)
public class GcpGroupByEncryptedKeyTest implements Serializable {
  ...
  public static void setup() throws IOException {
    ...
    gcpSecret = new GcpSecret(gcpSecretVersionName);
  ...
  public void testGroupByKeyGcpSecretThrows() {
    Secret badGcpSecret = new GcpSecret("bad_path/versions/latest");
    p.apply(Create.of(KV.of("k1", 1)))
        .apply(GroupByEncryptedKey.<String, Integer>create(badGcpSecret));
