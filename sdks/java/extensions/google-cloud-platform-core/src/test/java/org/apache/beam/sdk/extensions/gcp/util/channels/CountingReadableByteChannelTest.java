...
public class CountingReadableByteChannelTest {
  @Mock private ReadableByteChannel delegate;

  @Mock private ByteBuffer byteBuffer;

  @Mock private Consumer<Integer> consumer;

  @InjectMocks private CountingReadableByteChannel countingReadableByteChannel;
  ...
  public void delegateMethodsAreCalled() throws Exception {
    ...
    countingReadableByteChannel.read(byteBuffer);
  ...
  public void bytesReadAreReportedToConsumer() throws Exception {
    ...
    countingReadableByteChannel.read(byteBuffer);
    Mockito.verify(consumer).accept(bytesRead);
  }
}
