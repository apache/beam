...
public class GcsUtil {
  ...
  private GcsUtil(
    ...
    googleCloudStorageOptions = GoogleCloudStorageOptions.newBuilder()
        .setAppName("Beam")
  ...
  public WritableByteChannel create(GcsPath path, String type, Integer uploadBufferSizeBytes)
    ...
    AsyncWriteChannelOptions newOptions =
        AsyncWriteChannelOptions.builder()
            ...
            .build();
    GoogleCloudStorageOptions newGoogleCloudStorageOptions = googleCloudStorageOptions.toBuilder()
