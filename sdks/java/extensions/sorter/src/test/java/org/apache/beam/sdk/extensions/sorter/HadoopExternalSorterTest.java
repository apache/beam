...
public class HadoopExternalSorterTest {
  ...
  public void testEmpty() throws Exception {
    SorterTestUtils.testEmpty(
        HadoopExternalSorter.create(
            new HadoopExternalSorter.Options().setTempLocation(tmpLocation.toString())));
  }
  ...
  public void testNegativeMemory() {
    ...
    HadoopExternalSorter.Options options = new HadoopExternalSorter.Options();
