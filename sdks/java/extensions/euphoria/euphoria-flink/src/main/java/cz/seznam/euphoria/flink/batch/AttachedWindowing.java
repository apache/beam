...
class AttachedWindowing
    implements Windowing<Object, Object, AttachedWindowing.AttachedWindowContext > {
  ...
  @Override
  public Set<WindowID<Object>> assignWindowsToElement(WindowedElement<?, Object> input) {
