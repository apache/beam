...
public class AvroUtilsTest {
    ...
    return new Schema.Builder()
        ...
        .addField(
            Field.of(
                "decimal",
                FieldType.DECIMAL,
                Schema.Options.setOption("precision", FieldType.INT32, Integer.MAX_VALUE)
                    .setOption("scale", FieldType.INT32, 0)
  ...
  private static final BigDecimal BIG_DECIMAL_INT = new BigDecimal(3600);
  ...
  private static GenericRecord getGenericRecord() {
    ...
    ByteBuffer encodedDecimal =
        new Conversions.DecimalConversion().toBytes(BIG_DECIMAL_INT, null, decimalType);
