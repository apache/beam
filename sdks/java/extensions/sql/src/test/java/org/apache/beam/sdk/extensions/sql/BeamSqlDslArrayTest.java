...
public class BeamSqlDslArrayTest {
    ...
    PCollection<Row> result =
        input.apply(
            ...
            QueryTransform.withQueryString(
                "SELECT 42, ARRAY ['aa', 'bb'] as `f_arr` FROM PCOLLECTION"));
  ...
  public void testProjectArrayField() {
    ...
    PCollection<Row> result =
        input.apply(
            "sqlQuery",
            QueryTransform.withQueryString("SELECT f_int, f_stringArr FROM PCOLLECTION"));
  ...
  public void testAccessArrayElement() {
    ...
    PCollection<Row> result =
        input.apply(
            "sqlQuery", QueryTransform.withQueryString("SELECT f_stringArr[0] FROM PCOLLECTION"));
  ...
  public void testSingleElement() throws Exception {
    ...
    PCollection<Row> result =
        input.apply(
            "sqlQuery",
            QueryTransform.withQueryString("SELECT ELEMENT(f_stringArr) FROM PCOLLECTION"));
  ...
  public void testCardinality() {
    ...
    PCollection<Row> result =
        input.apply(
            "sqlQuery",
            QueryTransform.withQueryString("SELECT CARDINALITY(f_stringArr) FROM PCOLLECTION"));
  ...
  public void testUnnestLiteral() {
    ...
    PCollection<Row> result =
        inputTuple.apply(
            "sqlQuery",
            QueryTransform.withQueryString("SELECT * FROM UNNEST (ARRAY ['a', 'b', 'c'])"));
  ...
  public void testSelectRowsFromArrayOfRows() {
    ...
    PCollection<Row> result =
        input
            .apply(QueryTransform.withQueryString("SELECT f_arrayOfRows FROM PCOLLECTION"))
  ...
  public void testSelectSingleRowFromArrayOfRows() {
    ...
    PCollection<Row> result =
        input
            .apply(QueryTransform.withQueryString("SELECT f_arrayOfRows[1] FROM PCOLLECTION"))
            .setCoder(resultSchema.getRowCoder());
