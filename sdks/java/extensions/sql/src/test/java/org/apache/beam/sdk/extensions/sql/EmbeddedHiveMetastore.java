 ...
 * /HCatBaseTest.java </a>
 *
 * <p>Similar class exists HCatalogIO tests.
 */
final class EmbeddedHiveMetastore implements AutoCloseable {
  private final Driver driver;
  private final HiveConf hiveConf;
  private final SessionState sessionState;

  EmbeddedHiveMetastore(String baseDirPath) throws IOException {
    ...
    String testDataDirPath =
        makePathASafeFileName(
            hiveDirPath
                + "/data/"
                + EmbeddedHiveMetastore.class.getCanonicalName()
    ...
    hiveConf.setBoolVar(HiveConf.ConfVars.METASTORE_FASTPATH, true);
    hiveConf.setVar(
