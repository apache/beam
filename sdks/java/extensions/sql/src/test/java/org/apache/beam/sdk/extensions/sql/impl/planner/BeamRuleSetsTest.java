...
/** Tests for {@link BeamRuleSets}, verifying the composition of the active planner rule set. */
public class BeamRuleSetsTest {
  ...
  public void testProjectSetOpTransposeIsDisabled() {
    ...
    for (RuleSet ruleSet : ruleSets) {
      for (org.apache.beam.vendor.calcite.v1_40_0.org.apache.calcite.plan.RelOptRule rule :
          ruleSet) {
    ...
    assertFalse(
        "CoreRules.PROJECT_SET_OP_TRANSPOSE should NOT be enabled in the active rule set, "
            + "as it collapses IEEE-754 FP surrogates around FLOAT/DOUBLE set-operation columns, "
  ...
  public void testFilterSetOpTransposeIsEnabled() {
    ...
    assertTrue(
        "CoreRules.FILTER_SET_OP_TRANSPOSE should be enabled in the active rule set",
