...
public class BeamSqlDslAggregationTest extends BeamSqlDslBase {
  ...
  public void testBitAndFunctionWithOnlyNullInput() throws Exception {
    ...
    //    To try running them, uncomment the code and import required data structures such as ParDo
    // and DoFn.
  ...
  /**
   * The following commented test checks the condition when inputs contain both null value and valid
   * INT64 values.
   *
