...
public class BeamSqlArrayExpressionTest {
  ...
  public void testEvaluatesToList() {
    List<BeamSqlExpression> elements =
        ImmutableList.of(
            BeamSqlPrimitive.of(SqlTypeName.VARCHAR, "aaa"),
            BeamSqlPrimitive.of(SqlTypeName.VARCHAR, "bbb"));
  ...
  public void testAcceptsElementsWithOneType() {
    ...
    assertTrue(arrayExpression.accept());
  }
  ...
  public void testAcceptsElementsWithMultipleTypes() {
    List<BeamSqlExpression> elements =
        ImmutableList.of(
            BeamSqlPrimitive.of(SqlTypeName.VARCHAR, "aaa"),
            BeamSqlPrimitive.of(SqlTypeName.CHAR, "bbb"));

    BeamSqlArrayExpression arrayExpression = new BeamSqlArrayExpression(elements);

    assertFalse(arrayExpression.accept());
  }
}
