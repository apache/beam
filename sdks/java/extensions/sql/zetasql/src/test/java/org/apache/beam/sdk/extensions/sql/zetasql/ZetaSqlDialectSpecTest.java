...
public class ZetaSqlDialectSpecTest extends ZetaSqlTestBase {
  ...
  @Test
  public void testZetaSQLStddevPop() {
    String sql = "SELECT STDDEV_POP(row_id) FROM table_all_types GROUP BY bool_col";
  ...
  @Test
  public void testZetaSQLStddev() {
    String sql = "SELECT STDDEV(row_id) FROM table_all_types GROUP BY bool_col";
