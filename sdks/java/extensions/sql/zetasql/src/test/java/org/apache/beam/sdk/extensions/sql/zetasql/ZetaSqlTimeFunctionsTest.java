...
public class ZetaSqlTimeFunctionsTest extends ZetaSqlTestBase {
  ...
  // TODO[Issue 19980]: Add a test for CURRENT_DATE function ("SELECT CURRENT_DATE()")
  ...
  public void testExtractFromDate() {
    String sql =
        "WITH Dates AS (\n"
            ...
            // TODO[Issue 20338]: Add tests for DATE_TRUNC and EXTRACT with "week with weekday" date
  ...
  // TODO[Issue 19980]: Add a test for CURRENT_TIME function ("SELECT CURRENT_TIME()")
  ...
  // TODO[Issue 19980]: Add a test for CURRENT_DATETIME function ("SELECT CURRENT_DATETIME()")
  ...
  public void testExtractFromDateTime() {
    String sql =
        "SELECT "
            ...
            // TODO[Issue 20338]: Add tests for DATETIME_TRUNC and EXTRACT with "week with weekday"
  ...
  // TODO[Issue 19980]: Add a test for CURRENT_TIMESTAMP function ("SELECT CURRENT_TIMESTAMP()")
  ...
  public void testExtractFromTimestamp() {
    String sql =
        "WITH Timestamps AS (\n"
            ...
            // TODO[Issue 20338]: Add tests for TIMESTAMP_TRUNC and EXTRACT with "week with weekday"
            //  date parts once they are supported
