...
public abstract class TSConfiguration implements Serializable {
  ...
  public static TSConfiguration createConfigurationFromOptions(TimeSeriesOptions options )
  {
      ...
      configuration.downSampleDuration(Duration.millis(timeSeriesOptions.getDownSampleDurationMillis()));

      configuration.fillOption(BFillOptions.valueOf(Optional.ofNullable(timeSeriesOptions.getFillOption()).orElse("NONE")));
