...
public class BiTemporalCacheTestIT implements Serializable {
  ...
  static final int TRADE_QUOTE_SIZE = 10000;
  static final Duration WINDOW_DURATION = Duration.standardDays(30);
  private static final Logger LOG = LoggerFactory.getLogger(BiTemporalCacheTestIT.class);

  @Rule public transient TestPipeline p = TestPipeline.create();

  @Test
  @Category({NeedsRunner.class})
  public void largeCacheTest() {
    ...
    PCollection<KV<String, QuoteData>> quotes =
        ...
        p.apply("Create Quotes", Create.of(1))
            .apply(
                "Generate Quotes",
                ParDo.of(
                    new DoFn<Integer, KV<String, QuoteData>>() {

                      @ProcessElement
                      public void process(
                          @Element Integer m, OutputReceiver<KV<String, QuoteData>> o) {
