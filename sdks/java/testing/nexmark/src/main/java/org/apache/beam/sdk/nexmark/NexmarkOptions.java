...
public interface NexmarkOptions
  ...
  @Nullable String getSkipQueries();
  ...
  @Nullable Integer getStreamTimeout();
  ...
  @Nullable Boolean getUseWallclockEventTime();
  ...
  @Nullable Integer getNumInFlightAuctions();
  ...
  @Nullable String getJavascriptFilename();
  ...
  @Nullable Integer getAuctionSkip();
  ...
  @Nullable Integer getMaxAuctionsWaitingTime();
  ...
  @Nullable Boolean getUsePubsubPublishTime();
  ...
  @Nullable String getBootstrapServers();
