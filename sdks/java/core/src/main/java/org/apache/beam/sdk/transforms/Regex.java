...
public class Regex {
  ...
  /**
   * Returns a {@link Regex.MatchesName} {@link PTransform} that checks if the entire line
  ...
  /**
   * Returns a {@link Regex.MatchesName} {@link PTransform} that checks if the entire
   * line matches the Regex. Returns the group as a {@link PCollection}.
   *
   * @param pattern The regular expression to run
   * @param groupName The Regex group name to return as a PCollection
   */
  ...
  /**
   * Returns a {@link Regex.AllMatches} {@link PTransform} that checks if the
   * entire line matches the Regex. Returns all groups as a List&lt;String&gt; in a
   * {@link PCollection}.
   *
   * @param regex The regular expression to run
   */
  ...
  /**
   * Returns a {@link Regex.MatchesNameKV} {@link PTransform} that checks if the
   * entire line matches the Regex. Returns the specified groups as the key and value as a
   * {@link PCollection}.
   *
   * @param regex The regular expression to run
   ...
   * @param valueGroupName The Regex group name to use the value
   */
  public static MatchesNameKV matchesKV(Pattern pattern, String keyGroupName,
  ...
  /**
   * Returns a {@link Regex.FindName} {@link PTransform} that checks if a portion of the
   * line matches the Regex. Returns the group as a {@link PCollection}.
   *
   * @param regex The regular expression to run
   * @param groupName The Regex group name to return as a PCollection
  ...
  /**
   * Returns a {@link Regex.FindName} {@link PTransform} that checks if a portion
   * of the line matches the Regex. Returns the group as a {@link PCollection}.
   *
   * @param pattern The regular expression to run
   * @param groupName The Regex group name to return as a PCollection
   */
  ...
  /**
   * Returns a {@link Regex.FindNameKV} {@link PTransform} that checks if a portion of the
   * line matches the Regex. Returns the specified groups as the key and value as a
   * {@link PCollection}.
   *
   * @param regex The regular expression to run
   * @param keyGroupName The Regex group name to use as the key
  ...
  /**
   * {@code Regex.MatchesName<String>} takes a {@code PCollection<String>} and returns a {@code
   * PCollection<String>} representing the value extracted from all the Regex groups of the
  ...
  /**
   * {@code Regex.MatchesNameKV<KV<String, String>>} takes a {@code PCollection<String>}
   * and returns a {@code PCollection<KV<String, String>>} representing the key and value
   * extracted from the Regex groups of the input {@code PCollection} to the number of
   * times that element occurs in the input.
   *
   * <p>This transform runs a Regex on the entire input line. If the entire line does not match the
   * Regex, the line will not be output. If it does match the entire line, the groups in the Regex
   * will be used. The key will be the key's group and the value will be the value's group.
   ...
   *
   * <p>This transform runs a Regex on the entire input line. If a portion of the line does not
   * match the Regex, the line will not be output. If it does match a portion of the line,
   * the groups in the Regex will be used. The output will be the Regex groups.
   *
   * <p>Example of use:
   *
   * <pre>{@code
