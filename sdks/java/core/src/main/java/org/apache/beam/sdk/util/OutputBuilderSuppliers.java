...
public class OutputBuilderSuppliers {
  ...
  public static OutputBuilderSupplier forReceiver(ValueWithMetadataMultiReceiver receiver) {
  ...
  private static class OutputBuilderSupplierForReceiver implements OutputBuilderSupplier {
    private final ValueWithMetadataMultiReceiver receiver;

    OutputBuilderSupplierForReceiver(ValueWithMetadataMultiReceiver receiver) {
      this.receiver = receiver;
    }

    @Override
    public <OutputT> OutputBuilder<OutputT> builder(TupleTag<OutputT> tag) {
      return WindowedValue.builder(receiver.forTag(tag));
    }
  }
