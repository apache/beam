...
public class WriteFilesResult implements POutput {
  ...
  private final TupleTag<KV<?, String>> outputFilenamesTag;
  private final PCollection outputFilenames;

  private WriteFilesResult(
      Pipeline pipeline,
      TupleTag<KV<?, String>> outputFilenamesTag,
      PCollection<KV<?, String>> outputFilenames) {
  ...
  static  WriteFilesResult in(
      Pipeline pipeline, TupleTag<KV<?, String>> outputFilenamesTag,
      PCollection<KV<?, String>> outputFilenames) {
   ...
   */
  public <DestinationT> PCollection<KV<DestinationT, String>>  getPerDestinationOutputFilenames() {
    return (PCollection<KV<DestinationT, String>>) outputFilenames;
  }
  ...
  public PCollection<String> getOutputFilenames() {
    return ((PCollection<KV<?, String>>) outputFilenames).apply(
        "ExtractFilenamesFromResult", Values.<String>create());
  }
}
