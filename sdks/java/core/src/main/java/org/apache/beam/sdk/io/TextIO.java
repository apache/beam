 ...
 * {@link PCollection} you can use {@link FileIO} to match them and {@link TextIO#readFiles} to read
 * them.
 *
 ...
 * combination of {@link FileIO.Match#continuously(Duration, TerminationCondition)} and
 * {@link #readFiles()} allow streaming of new files matching the filepattern(s).
 *
 * <p>By default, {@link #read} prohibits filepatterns that match no files, and
 * {@link #readFiles()} allows them in case the filepattern contains a glob wildcard character. Use
 * {@link Read#withEmptyMatchTreatment} or
 * {@link FileIO.Match#withEmptyMatchTreatment(EmptyMatchTreatment)} plus {@link #readFiles()} to
...
public class TextIO {
  ...
  /**
   * A {@link PTransform} that works like {@link #read}, but reads each file in a
   * {@link PCollection} of filepatterns.
   *
   ...
   * matching plus {@link #readFiles()}. This is the preferred method to make composition explicit.
   ...
   * {@link FileIO.ReadableFile}, returned by {@link FileIO#readMatches}.
   */
   ...
   * object this is done using {@link DynamicDestinations#formatRecord}, otherwise the
   * {@link TypedWrite#withFormatFunction} can be used to specify a format function.
   *
  ...
  public abstract static class Read extends PTransform<PBegin, PCollection<String>> {
     ...
     *
     * <p>If it is known that the filepattern will match a very large number of files (at least
     * tens of thousands), use {@link #withHintMatchesManyFiles} for better performance and
     * scalability.
     */
    ...
    /**
     * Same as {@link Read#watchForNewFiles(Duration, TerminationCondition, boolean)} with
     * {@code matchUpdatedFiles=false}.
     */
    public Read watchForNewFiles(
  ...
  public abstract static class ReadFiles
    ...
    private static class CreateTextSourceFn
      ...
      public FileBasedSource<String> apply(String input) {
        return new TextSource(StaticValueProvider.of(input), EmptyMatchTreatment.DISALLOW,
            delimiter);
      }
    }
  }
  ...
  public abstract static class TypedWrite<UserT, DestinationT>
     ...
     * {@link #to(DynamicDestinations)} is used, {@link DynamicDestinations#formatRecord(Object)}
     ...
     * of the default filename-prefix to() overrides - i.e. not when using either
     * {@link #to(FilenamePolicy)} or {@link #to(DynamicDestinations)}.
     *
     * <p>See {@link DefaultFilenamePolicy} for how the prefix, shard name template, and suffix are
     * used.
     */
  ...
  public static class Write extends PTransform<PCollection<String>, PDone> {
     ...
     *
     * @deprecated Use {@link FileIO#write()} or {@link FileIO#writeDynamic()} ()} with
     * {@link #sink()} instead.
     */
    @Deprecated
     ...
     * #to(DynamicDestinations)} if that method was used; {@link Params} if
     * {@link #to(SerializableFunction, Params)} was used, or {@code Void} otherwise.
     */
  ...
  /**
   * Creates a {@link Sink} that writes newline-delimited strings in UTF-8, for use with
   * {@link FileIO#write}.
   */
