...
public class WithTimestamps<T> extends PTransform<PCollection<T>, PCollection<T>> {
   ...
   * be silently dropped. See https://github.com/apache/beam/issues/179764 for details on a
   * replacement.
   *
   ...
   *     https://github.com/apache/beam/issues/179764 for details on a replacement.
   */
  @Deprecated
