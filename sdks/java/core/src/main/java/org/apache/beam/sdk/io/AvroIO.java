...
public class AvroIO {
  ...
  public static Read<GenericRecord> readGenericRecords() {
    return new Read<>(GenericRecord.class);
  }
  ...
  public static Write<GenericRecord> writeGenericRecords() {
    return new Write<>(GenericRecord.class);
  }
  ...
  public static class Read<T> extends PTransform<PBegin, PCollection<T>> {
    ...
    private Read(Class<T> type) {
      this(null, null, type, null, true);
    }

    private Read(String name, String filepattern, Class<T> type, Schema schema, boolean validate) {
      super(name);
    ...
    public Read<T> from(String filepattern) {
      return new Read<>(name, filepattern, type, schema, validate);
    }
    ...
    public  Read<T> withSchema(Class<T> type) {
      return new Read<>(name, filepattern, type, ReflectData.get().getSchema(type), validate);
    }
     ...
     */
    public Read<T> withSchema(Schema schema) {
     ...
     * <p>Does not modify this object.
     */
    public Read<T> withSchema(String schema) {
    ...
    public Read<T> withoutValidation() {
      return new Read<>(name, filepattern, type, schema, false);
    }
  ...
  public static class Write<T> extends PTransform<PCollection<T>, PDone> {
     ...
     * <p>Does not modify this object.
     */
    public Write<T> withSchema(String schema) {
      return withSchema((new Schema.Parser()).parse(schema));
    }
