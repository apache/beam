...
public class Window {
  ...
  private static void populateWindowingStrategyDisplayData(
    ...
    if (windowingStrategy.getWindowFn() != null) {
      builder
          .add(
    ...
    if (windowingStrategy.getAllowedLateness() != null) {
    ...
    if (windowingStrategy.getTrigger() != null
