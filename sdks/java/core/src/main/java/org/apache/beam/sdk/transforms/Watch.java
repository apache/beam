...
public class Watch {
  ...
  static class GrowthTracker<OutputT, TerminationStateT>
    ...
    public SplitResult<GrowthState> trySplit(double fractionOfRemainder) {
      // TODO(https://github.com/apache/beam/issues/19908): Add support for splitting off a fixed amount of work for this
      // restriction instead of only supporting checkpointing.
