      ...
      return
          ImmutableList.<Object[]>builder()
              .add(
                  ...
                  new Object[] {
                      null,
                      AvroIO.readGenericRecords().withSchema(SCHEMA),
                      "AvroIO.Read/Read.out",
                  ...
                  new Object[] {
                      null,
                      AvroIO.readGenericRecords().withSchema(SCHEMA_STRING),
                      "AvroIO.Read/Read.out",
                      generateAvroGenericRecords(),
                      fromSchemaString
                  },
      ...
      return
          ImmutableList.<Object[]>builder()
              .add(
                  ...
                  new Object[] {
                      AvroIO.writeGenericRecords().withSchema(SCHEMA),
                      fromSchema
                  },

                  new Object[] {
                      AvroIO.writeGenericRecords().withSchema(SCHEMA_STRING),
                      fromSchemaString
                  })
              .build();
    }
