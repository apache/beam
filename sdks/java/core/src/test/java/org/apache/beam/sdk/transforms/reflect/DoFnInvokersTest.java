        ...
        new FakeArgumentProvider<String, String>() {
          ...
          public OutputReceiver<SomeRestriction> outputReceiver(DoFn doFn) {
            return new OutputReceiver<SomeRestriction>() {
              @Override
              public OutputBuilder<SomeRestriction> builder() {
                return WindowedValue.builder(builder -> outputs.add(builder.getValue()));
              }
            };
          }
        });
        ...
        new FakeArgumentProvider<String, String>() {
          ...
          public OutputReceiver<String> outputReceiver(DoFn<String, String> doFn) {
            return new DoFn.OutputReceiver<String>() {
              ...
              @Override
              public OutputBuilder<String> builder() {
                return WindowedValue.builder(
                    outputBuilder -> {
                      assertFalse(invoked);
                      invoked = true;
                      assertEquals("foo", outputBuilder.getValue());
                    });
              }
            };
          }
