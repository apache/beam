...
public class ReifyTest implements Serializable {
  public static final WithTimestamps<KV<String, Integer>>
      TIMESTAMP_FROM_V = WithTimestamps.of(
  ...
  public void globalWindowNoKeys() {
    PCollection<ValueInSingleWindow<String>> result = pipeline
        .apply(TestStream
            .create(StringUtf8Coder.of())
            .addElements(TimestampedValue.of("dei", new Instant(123L)))
            .advanceWatermarkToInfinity())
        .apply(Reify.<String>windows());
    PAssert.that(result).containsInAnyOrder(ValueInSingleWindow.of("dei", new Instant(123L),
  ...
  public void timestampsSucceeds() {
    PCollection<String> timestamped =
        pipeline
            .apply(Create.timestamped(TimestampedValue.of("foo", new Instant(0L)),
  ...
  public void windowsInValueSucceeds() {
    ...
    PAssert.that(reified)
        .containsInAnyOrder(
            KV.of("foo", ValueInSingleWindow.of(0, new Instant(0), GlobalWindow.INSTANCE,
                PaneInfo.NO_FIRING)),
            KV.of("foo", ValueInSingleWindow.of(1, new Instant(1), GlobalWindow.INSTANCE,
                PaneInfo.NO_FIRING)),
            KV.of("bar", ValueInSingleWindow.of(2, new Instant(2), GlobalWindow.INSTANCE,
                PaneInfo.NO_FIRING)),
            KV.of("baz", ValueInSingleWindow.of(3, new Instant(3), GlobalWindow.INSTANCE,
                PaneInfo.NO_FIRING)));
