...
final class AutoValue_DoFnSignature_TruncateRestrictionMethod extends DoFnSignature.TruncateRestrictionMethod {
  ...
  AutoValue_DoFnSignature_TruncateRestrictionMethod(
      Method targetMethod,
  ...
  public String toString() {
    return "TruncateRestrictionMethod{"
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o instanceof DoFnSignature.TruncateRestrictionMethod) {
      DoFnSignature.TruncateRestrictionMethod that = (DoFnSignature.TruncateRestrictionMethod) o;
