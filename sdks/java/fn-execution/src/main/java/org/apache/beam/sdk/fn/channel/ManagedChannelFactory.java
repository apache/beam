...
import org.apache.beam.vendor.grpc.v1p37p0.io.netty.channel.epoll.EpollDomainSocketChannel;
import org.apache.beam.vendor.grpc.v1p37p0.io.netty.channel.epoll.EpollEventLoopGroup;
import org.apache.beam.vendor.grpc.v1p37p0.io.netty.channel.epoll.EpollSocketChannel;
...
public abstract class ManagedChannelFactory {
  ...
  public static ManagedChannelFactory createEpoll() {
    org.apache.beam.vendor.grpc.v1p37p0.io.netty.channel.epoll.Epoll.ensureAvailability();
    return new Epoll();
  }
