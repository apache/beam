...
class SettableFutureFutureInboundDataClient implements InboundDataClient {
  ...
  static InboundDataClient createWithBackingFuture(SettableFuture<Void> future) {
    return new SettableFutureFutureInboundDataClient(future);
  }

  private final SettableFuture<Void> future;

  private SettableFutureFutureInboundDataClient(SettableFuture<Void> future) {
    this.future = future;
  }
