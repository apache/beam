...
public class ManagedSchemaTransformProvider
  ...
  protected SchemaTransform<ManagedConfig> from(ManagedConfig managedConfig) {
    ...
    return new ManagedSchemaTransform(managedConfig, identifier(), schemaTransformProvider);
  }

  static class ManagedSchemaTransform extends SchemaTransform<ManagedConfig> {
