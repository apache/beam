...
import org.beam.sdk.java.sql.planner.BeamSqlRunner;
...
public class BeamSqlExample implements Serializable {
  ...
  public static void main(String[] args) throws Exception {
    ...
    runner.addTable("subrowverevent", 
        getTable("subrowverevent", "flink2-8332.lvs01.dev.ebayc3.com:9092", "subrowverevent"));
  ...
  public static BaseBeamTable getTable(String tableName, String bootstrapServer, String topic) {
    ...
    return new BeamKafkaTable(protoRowType,
