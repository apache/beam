...
class V1TestUtil {
  ...
  static Datastore getDatastore(PipelineOptions pipelineOptions, String projectId, String databaseId) {
  ...
  private static RunQueryRequest makeRequest(String projectId, String databaseId, Query query, @Nullable String namespace) {
    RunQueryRequest.Builder requestBuilder = RunQueryRequest.newBuilder().setQuery(query).setProjectId(projectId).setDatabaseId(databaseId);
    if (namespace != null) {
  ...
  static void deleteAllEntities(V1TestOptions options, String project, String database, String ancestor)
      throws Exception {
    ...
    V1TestReader reader = new V1TestReader(datastore, project, database, query, options.getNamespace());
    V1TestWriter writer = new V1TestWriter(datastore, project, database, new DeleteMutationBuilder());
  ...
  static class V1TestWriter {
    ...
    V1TestWriter(Datastore datastore, String projectId, String databaseId, MutationBuilder mutationBuilder) {
  ...
  static class V1TestReader {
    ...
    V1TestReader(Datastore datastore, String projectId, String databaseId, Query query, @Nullable String namespace) {
      this.datastore = datastore;
      this.projectId = projectId;
      this.databaseId = databaseId;
      this.query = query;
