...
public class FhirIOWriteR4IT {
  ...
  public void setup() throws Exception {
    ...
    options.setGcsTempPath(
        String.format("gs://%s/FhirIOWriteR4IT/%s/temp/", TEMP_BUCKET, testTime));
    options.setGcsDeadLetterPath(
        String.format("gs://%s/FhirIOWriteR4IT/%s/deadletter/", TEMP_BUCKET, testTime));
