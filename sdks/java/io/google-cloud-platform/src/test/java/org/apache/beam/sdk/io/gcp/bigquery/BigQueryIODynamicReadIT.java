...
/**
 * Integration tests for {@link BigQueryIO#readDynamically(SerializableFunction,
 * org.apache.beam.sdk.coders.Coder)} using {@link Method#DIRECT_READ}. This test reads from a
 * pre-defined table and asserts that the number of records read is equal to the expected count.
 */
@RunWith(JUnit4.class)
public class BigQueryIODynamicReadIT {
  ...
  private BigQueryIODynamicReadOptions options;

  /** Customized {@link TestPipelineOptions} for BigQueryIOStorageRead pipelines. */
  public interface BigQueryIODynamicReadOptions extends TestPipelineOptions, ExperimentalOptions {
  ...
  private void setUpTestEnvironment(String tableSize, DataFormat format) {
    PipelineOptionsFactory.register(BigQueryIODynamicReadOptions.class);
    options = TestPipeline.testingPipelineOptions().as(BigQueryIODynamicReadOptions.class);
  ...
  private void runBigQueryIODynamicReadPipeline() {
  ...
  private void runBigQueryIODynamicReadPipelineErrorHandling() throws Exception {
    Pipeline p = Pipeline.create(options);
