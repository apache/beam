...
public class BigQueryIOStorageReadWithoutDynamicWorkflowRebalancingTest {
  ...
  public void testTableSourceInitialSplit() throws Exception {
    doTableSourceInitialSplitTest(1024L, 1024, -1);
  }

  @Test
  public void testTableSourceInitialSplit_MinSplitCount() throws Exception {
    doTableSourceInitialSplitTest(1024L * 1024L, 10, -1);
  }

  @Test
  public void testTableSourceInitialSplit_MaxSplitCount() throws Exception {
    doTableSourceInitialSplitTest(10L, 10_000, -1);
  }

  @Test
  public void testTableSourceInitialSplit_WithInitialStreamCountOptionSpecified() throws Exception {
    doTableSourceInitialSplitTest(1024L * 1024L, 10_000, 101);
  }
  ...
  private void doTableSourceInitialSplitTest(
      long bundleSize, int streamCount, int initialStreamCountOption) throws Exception {
    fakeDatasetService.createDataset("foo.com:project", "dataset", "", "", null);
    TableReference tableRef = BigQueryHelpers.parseTableSpec("foo.com:project:dataset.table");
  ...
  @Test
  public void testStreamSourceSplitAtFractionNoOp() throws Exception {
    ...
    // Now split the stream, and ensure that the "parent" reader has NOT been replaced with the
    // primary stream and that there is no returned residual source.
    BoundedSource<TableRow> residualSource = parent.splitAtFraction(0.5);
    assertNull(residualSource);
  ...
  @Test
  public void testStreamSourceSplitAtFractionNoOpArrow() throws Exception {
    List<String> names = Arrays.asList("A", "B", "C", "D", "E", "F", "G");
    List<Long> values = Arrays.asList(1L, 2L, 3L, 4L, 5L, 6L, 7L);
    List<ReadRowsResponse> parentResponses =
        Lists.newArrayList(
