...
public class BigQueryIODynamicQueryIT {
  ...
  public interface BigQueryIOQueryOptions extends TestPipelineOptions, ExperimentalOptions {
  ...
  private void setUpTestEnvironment(String tableSize) {
    ...
    options = TestPipeline.testingPipelineOptions().as(BigQueryIOQueryOptions.class);
  ...
  @Test
  public void testBigQueryDynamicQuery1G() throws Exception {
    setUpTestEnvironment("1G");
    runBigQueryIODynamicQueryPipeline();
  }
  ...
  @Test
  public void testBigQueryDynamicQueryWithErrorHandling1M() throws Exception {
