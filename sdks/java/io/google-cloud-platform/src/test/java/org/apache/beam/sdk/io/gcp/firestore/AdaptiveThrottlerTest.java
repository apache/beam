...
public class AdaptiveThrottlerTest {
    ...
    private static final long SAMPLE_PERIOD_MS = 60000;
    private static final long SAMPLE_BUCKET_MS = 1000;
    private static final double OVERLOAD_RATIO = 2;

    /**
     * Returns a throttler configured with the standard parameters above.
     */
    private AdaptiveThrottler getThrottler() {
