...
public class SpannerChangeStreamProtoBasedIT {

  @ClassRule public static final IntegrationTestEnv ENV = new IntegrationTestEnv(/*isPostgres=*/false, /*isProtoBasedChangeStream=*/true);
