  ...
  public void testIsPayloadSchemaOutOfDate() throws Exception {
    ...
    assertFalse(
        UpgradeTableSchema.isPayloadSchemaOutOfDate(
            payloadNoHash.getSchemaHash(),
            ByteString.copyFrom(payloadNoHash.getPayload()),
            () -> hash1,
            null));
    ...
    assertFalse(
        UpgradeTableSchema.isPayloadSchemaOutOfDate(
            payload.getSchemaHash(), ByteString.copyFrom(payload.getPayload()), () -> hash1, null));

    // 3. Different hash, but message doesn't have unknown fields (initialized and empty)
    assertFalse(
        UpgradeTableSchema.isPayloadSchemaOutOfDate(
            payload.getSchemaHash(),
    ...
    assertTrue(
        UpgradeTableSchema.isPayloadSchemaOutOfDate(
            payloadWithUnknown.getSchemaHash(),
            ByteString.copyFrom(payloadWithUnknown.getPayload()),
            () -> hash2,
            () -> descriptor));
    ...
    assertTrue(
        UpgradeTableSchema.isPayloadSchemaOutOfDate(
            payloadMissingField.getSchemaHash(),
            ByteString.copyFrom(payloadMissingField.getPayload()),
            () -> hash2,
            () -> descriptor));
  }

  @Test
  public void testMissingUnknownField_TableRowWithF() throws Exception {
    DescriptorProtos.DescriptorProto descriptorProto =
        DescriptorProtos.DescriptorProto.newBuilder()
            .setName("TestMessage")
            .addField(
    ...
    cell1.setV("value1");
    row.set("f", Arrays.asList(cell1));

    assertFalse(UpgradeTableSchema.missingUnknownField(row, () -> descriptor));

    TableCell cell2 = new TableCell();
    cell2.setV("value2");
    row.set("f", Arrays.asList(cell1, cell2));

    assertTrue(UpgradeTableSchema.missingUnknownField(row, () -> descriptor));
  }

  @Test
  public void testMissingUnknownField_TableRow() throws Exception {
    DescriptorProtos.DescriptorProto descriptorProto =
        DescriptorProtos.DescriptorProto.newBuilder()
            .setName("TestMessage")
            .addField(
    ...
    row.set("field2", "value2");

    assertTrue(UpgradeTableSchema.missingUnknownField(row, () -> descriptor));
  }

  @Test
  public void testMissingUnknownField_NestedObject() throws Exception {
    DescriptorProtos.DescriptorProto nestedProto =
        DescriptorProtos.DescriptorProto.newBuilder()
    ...
    DescriptorProtos.DescriptorProto parentProto =
        DescriptorProtos.DescriptorProto.newBuilder()
            .setName("TestMessage")
            .addField(
                DescriptorProtos.FieldDescriptorProto.newBuilder()
    ...
    DescriptorProtos.FileDescriptorProto fileProto =
        DescriptorProtos.FileDescriptorProto.newBuilder()
            .addMessageType(nestedProto)
            .addMessageType(parentProto)
            .build();

    Descriptors.FileDescriptor fileDescriptor =
        Descriptors.FileDescriptor.buildFrom(fileProto, new Descriptors.FileDescriptor[0]);
    Descriptors.Descriptor descriptor = fileDescriptor.findMessageTypeByName("TestMessage");

    TableRow nestedRow = new TableRow();
    nestedRow.set("nested1", "value1");

    TableRow parentRow = new TableRow();
    parentRow.set("field1", nestedRow);

    assertFalse(UpgradeTableSchema.missingUnknownField(parentRow, () -> descriptor));

    nestedRow.set("nested2", "value2");
    assertTrue(UpgradeTableSchema.missingUnknownField(parentRow, () -> descriptor));
  }

  @Test
  public void testMissingUnknownField_NestedAndRepeatedObjectWithTableCells() throws Exception {
    DescriptorProtos.DescriptorProto nestedProto =
        DescriptorProtos.DescriptorProto.newBuilder()
            .setName("NestedMessage")
            .addField(
    ...
    TableRow nestedRowOk =
        new TableRow().setF(Collections.singletonList(new TableCell().setV("value1")));
    TableRow parentRow =
        new TableRow()
            .setF(
                Arrays.asList(
                    new TableCell().setV(nestedRowOk),
                    new TableCell()
                        .setV(Collections.singletonList(new TableCell().setV(nestedRowOk)))));

    assertFalse(UpgradeTableSchema.missingUnknownField(parentRow, () -> descriptor));

    TableRow nestedRowWithUnknown =
        new TableRow()
            .setF(Arrays.asList(new TableCell().setV("value1"), new TableCell().setV("value2")));
    TableRow parentWithSingleUnknown =
        new TableRow()
            .setF(
                Arrays.asList(
                    new TableCell().setV(nestedRowWithUnknown),
                    new TableCell()
                        .setV(Collections.singletonList(new TableCell().setV(nestedRowOk)))));
    assertTrue(UpgradeTableSchema.missingUnknownField(parentWithSingleUnknown, () -> descriptor));

    TableRow parentWithRepeatedUnknown =
        new TableRow()
            .setF(
                Arrays.asList(
                    new TableCell().setV(nestedRowOk),
                    new TableCell()
                        .setV(
                            Collections.singletonList(
                                new TableCell().setV(nestedRowWithUnknown)))));
    assertTrue(UpgradeTableSchema.missingUnknownField(parentWithRepeatedUnknown, () -> descriptor));
  }
}
