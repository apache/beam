...
public class BigQueryIODynamicReadTableRowIT {
  ...
  private BigQueryIODynamicReadTableRowOptions options;

  /** Private pipeline options for the test. */
  public interface BigQueryIODynamicReadTableRowOptions
  ...
  private void setUpTestEnvironment(String tableName) {
    PipelineOptionsFactory.register(BigQueryIODynamicReadTableRowOptions.class);
    options = TestPipeline.testingPipelineOptions().as(BigQueryIODynamicReadTableRowOptions.class);
  ...
  private static void runPipeline(BigQueryIODynamicReadTableRowOptions pipelineOptions) {
