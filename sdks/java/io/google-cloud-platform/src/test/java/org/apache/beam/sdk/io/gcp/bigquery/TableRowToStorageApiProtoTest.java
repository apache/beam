...
public class TableRowToStorageApiProtoTest {
              ...
              ImmutableList.<TableFieldSchema>builder()
                  ...
                  .add(
                      new TableFieldSchema()
                          ...
                          .setMode("REPEATED")
                          .setName("arrayValue"))
                  .add(new TableFieldSchema().setType("TIMESTAMP").setName("timestampValueMin"))
                  .add(new TableFieldSchema().setType("TIMESTAMP").setName("timestampValueMax"))
      ...
      new TableRow()
          .setF(
              Lists.newArrayList(
                  ...
                  new TableCell().setV("0001-01-01T00:00:00+00:00"),
                  new TableCell().setV("9999-12-31 23:59:59.999999"),
  ...
  private static final TableRow BASE_TABLE_ROW_NO_F =
      new TableRow()
          ...
          .set("timestampValueMin", "0001-01-01T00:00:00+00:00")
          .set("timestampValueMax", "9999-12-31 23:59:59.999999")
  ...
  private static final Map<String, Object> BASE_ROW_EXPECTED_PROTO_VALUES =
      ImmutableMap.<String, Object>builder()
          ...
          .put("timestampvaluemin", -62135596800000000L)
          .put("timestampvaluemax", 253402300799999999L)
