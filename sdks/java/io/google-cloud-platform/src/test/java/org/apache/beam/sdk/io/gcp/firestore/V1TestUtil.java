...
//
//    /**
//     * Build a new firestore client.
//     */
//    private static Firestore getFirestore(PipelineOptions pipelineOptions, String projectId) {
//        Credentials credential = pipelineOptions.as(GcpOptions.class).getGcpCredential();
//        if (credential == null) {
//            return FirestoreOptions.getDefaultInstance().getService();
//        }
//
//        return FirestoreOptions.newBuilder().setProjectId(projectId).setCredentials(credential).build().getService();
//    }
//
//    /**
...
//        Firestore firestore = getFirestore(options, project);
//
//        Query query = V1TestUtil.makeAncestorKindQuery(options.getKind(), options.getNamespace(), ancestor);
//
//        V1TestReader reader = new V1TestReader(firestore, query, options.getNamespace());
//        V1TestWriter writer = new V1TestWriter(firestore, new DeleteMutationBuilder());
//
//        long numEntities = 0;
...
//        // Read from datastore.
//        Datastore datastore = V1TestUtil.getFirestore(options, project);
//        Query query = V1TestUtil.makeAncestorKindQuery(options.getKind(), options.getNamespace(), ancestor);
//
...
//
//    /**
//     * A helper class to read entities from firestore.
//     */
...
//
//        V1TestReader(Firestore firestore, @Nullable String collection) {
...
//            }
//
//            RunQueryRequest request = makeRequest(query.build(), collection);
//            RunQueryResponse response = firestore.runQuery(request);
//
