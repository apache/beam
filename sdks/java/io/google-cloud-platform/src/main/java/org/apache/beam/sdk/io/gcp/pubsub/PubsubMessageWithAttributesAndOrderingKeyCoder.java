...
/** A coder for PubsubMessage including attributes and an ordering key from the PubSub server. */
@SuppressWarnings({
  "nullness" // TODO(https://issues.apache.org/jira/browse/BEAM-10402)
})
public class PubsubMessageWithAttributesAndOrderingKeyCoder extends CustomCoder<PubsubMessage> {
  ...
  // A message's orderingKey can be null
  ...
  public static PubsubMessageWithAttributesAndOrderingKeyCoder of() {
    return new PubsubMessageWithAttributesAndOrderingKeyCoder();
  }
  ...
  public PubsubMessage decode(InputStream inStream) throws IOException {
    ...
    return new PubsubMessage(payload, attributes, null, orderingKey);
  }
}
