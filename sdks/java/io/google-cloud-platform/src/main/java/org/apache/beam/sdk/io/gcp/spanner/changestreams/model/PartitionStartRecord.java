...
public class PartitionStartRecord implements ChangeStreamRecord {
   ...
   *
   * @param timestamp the timestamp which this partition started being valid in Cloud Spanner
  ...
  /**
   * It is the partition_start_time of the partition tokens. This partition_start_time is guaranteed
   * to be the same across all the partition start recordss yielded from a parent. When users start
   * new queries with the child partition tokens, the returned records must have a timestamp >=
