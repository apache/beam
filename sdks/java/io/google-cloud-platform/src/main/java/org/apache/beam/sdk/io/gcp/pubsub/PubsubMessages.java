...
public class PubsubMessages {
  ...
  public static byte[] pojoToProtoBytes(PubsubMessage input) {
    return pojoToProto(input).toByteArray();
  }

  public static com.google.pubsub.v1.PubsubMessage pojoToProto(PubsubMessage input) {
  ...
  public static PubsubMessage protoBytesToPojo(byte[] input) {
    try {
