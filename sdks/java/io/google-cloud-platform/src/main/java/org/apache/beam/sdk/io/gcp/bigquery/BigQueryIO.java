...
public class BigQueryIO {
  ...
  public abstract static class Write<T> extends PTransform<PCollection<T>, WriteResult> {
     ...
     *
     * <p>This is applicable when the write method is set to {@link Method#FILE_LOADS},
     * {@link Method#STORAGE_WRITE_API} or {@link Method#STORAGE_API_AT_LEAST_ONCE} and only when writing an unbounded {@link PCollection}.
     *
