...
import com.google.cloud.teleport.spanner.spannerio.changestreams.model.PartitionStartRecord;
 ...
 * SDF. It is responsible for processing {@link PartitionStartRecord}s. The new partition start
 * records will be stored in the Connector's metadata tables in order to be scheduled for future
 * querying by the {@link
...
public class PartitionStartRecordAction {
  ...
  // TODO duplicate - move to a common one
  private PartitionMetadata toPartitionMetadata(
      Timestamp startTimestamp,
      Timestamp endTimestamp,
      long heartbeatMillis,
      String startPartitionToken) {
