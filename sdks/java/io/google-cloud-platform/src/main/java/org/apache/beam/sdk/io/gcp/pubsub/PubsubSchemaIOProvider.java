...
public class PubsubSchemaIOProvider implements SchemaIOProvider {
  ...
  public Schema configurationSchema() {
    return Schema.builder()
        ...
        .addNullableField("payloadFormat", FieldType.STRING)
        .build();
  }
    ...
    public PTransform<PCollection<Row>, POutput> buildWriter() {
      ...
      return new PTransform<PCollection<Row>, POutput>() {
        ...
        public POutput expand(PCollection<Row> input) {
          return input
              .apply(RowToPubsubMessage.of(config.useTimestampAttribute(), config.payloadFormat()))
  ...
  abstract static class Config implements Serializable {
    ...
    abstract @Nullable String getPayloadFormat();
    ...
    PayloadFormat payloadFormat() {
      return getPayloadFormat() == null
          ? PayloadFormat.JSON
          : PayloadFormat.valueOf(getPayloadFormat().toUpperCase());
    }
  }
}
