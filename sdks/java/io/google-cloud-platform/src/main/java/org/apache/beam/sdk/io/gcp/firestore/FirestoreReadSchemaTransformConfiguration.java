...
/** Configuration class for the Firestore Read transform. */
@DefaultSchema(AutoValueSchema.class)
@AutoValue
public abstract class FirestoreReadSchemaTransformConfiguration implements Serializable {
  ...
  @SchemaFieldDescription("Firestore collection id to read from.")
  ...
  public void validate() {
    ...
    checkArgument(
        getSchema() != null && !getSchema().isEmpty(), "Firestore schema must be specified.");
  }

  public static Builder builder() {
    return new AutoValue_FirestoreReadSchemaTransformConfiguration.Builder();
  }
  ...
  public abstract static class Builder {
    ...
    public abstract FirestoreReadSchemaTransformConfiguration build();
  }
}
