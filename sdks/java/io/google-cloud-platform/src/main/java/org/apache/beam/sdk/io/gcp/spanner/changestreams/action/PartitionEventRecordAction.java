 ...
 * the watermark for the current element (partition). Note that once after this record, the
 * partition will not generate any incomming change records. As the result, the
 * QueryChangeStreamAction will mark the partition reading as finished by itself.
 */
