...
public class DatastoreV1 {
  ...
  public abstract static class Read extends PTransform<PBegin, PCollection<Entity>> {
    ...
    static int getEstimatedNumSplits(
        Datastore datastore, String projectId, String databaseId, Query query, @Nullable String namespace, @Nullable Instant readTime) {
      int numSplits;
      try {
        long estimatedSizeBytes = getEstimatedSizeBytes(datastore, projectId, databaseId, query, namespace, readTime);
    ...
    private static long queryLatestStatisticsTimestamp(
        Datastore datastore, String projectId, String databaseId, @Nullable String namespace, @Nullable Instant readTime)
    ...
    private static Entity getLatestTableStats(
      String projectId, String databaseId, String ourKind, @Nullable String namespace, Datastore datastore, @Nullable Instant readTime)
        throws DatastoreException {
      long latestTimestamp = queryLatestStatisticsTimestamp(datastore, projectId, databaseId, namespace, readTime);
    ...
    static long getEstimatedSizeBytes(
      ...
      Entity entity = getLatestTableStats(projectId, databaseId, ourKind, namespace, datastore, readTime);
    ...
    static RunQueryRequest makeRequest(
      String projectId, String databaseId, Query query, @Nullable String namespace, @Nullable Instant readTime) {
     ...
     */
    static RunQueryRequest makeRequest(String projectId, String databaseId,
    ...
    static Query translateGqlQueryWithLimitCheck(
        String gql, Datastore datastore, String projectId, String databaseId, String namespace, @Nullable Instant readTime)
        throws DatastoreException {
    ...
    public long getNumEntities(
      ...
      try {
        V1Options v1Options = V1Options.from(getProjectId(), getDatabaseId(), getNamespace(), getLocalhost());
        V1DatastoreFactory datastoreFactory = new V1DatastoreFactory();
        Datastore datastore =
            datastoreFactory.getDatastore(
                options, v1Options.getProjectId(), v1Options.getDatabaseId(), v1Options.getLocalhost());

        Entity entity = getLatestTableStats(v1Options.getProjectId(), v1Options.getDatabaseId(), ourKind, namespace, datastore, getReadTime());
    ...
    static class V1Options implements HasDisplayData, Serializable {
      ...
      private V1Options(
          ValueProvider<String> project, ValueProvider<String> database, ValueProvider<String> namespace, String localhost) {
      ...
      public static V1Options from(String projectId, ValueProvider<String>  databaseId, String namespace, String localhost) {
        return from(
            StaticValueProvider.of(projectId), databaseId, StaticValueProvider.of(namespace), localhost);
      }

      public static V1Options from(
          ValueProvider<String> project, ValueProvider<String> databaseId, ValueProvider<String> namespace, String localhost) {
      ...
      public String getDatabaseId() {
        return database == null ? "" : database.get();
      }
    ...
    static class GqlQueryTranslateFn extends DoFn<String, Query> {
      ...
      public void startBundle(StartBundleContext c) throws Exception {
        datastore =
            datastoreFactory.getDatastore(
                c.getPipelineOptions(), v1Options.getProjectId(), v1Options.getDatabaseId(), v1Options.getLocalhost());
      }
      ...
      public void processElement(ProcessContext c) throws Exception {
        ...
        Query query =
            translateGqlQueryWithLimitCheck(
                gqlQuery, datastore, v1Options.getProjectId(), v1Options.getDatabaseId(), v1Options.getNamespace(), readTime);
    ...
    static class SplitQueryFn extends DoFn<Query, Query> {
      ...
      public void startBundle(StartBundleContext c) throws Exception {
        datastore =
            datastoreFactory.getDatastore(
                c.getPipelineOptions(), options.getProjectId(), options.getDatabaseId(), options.getLocalhost());
      ...
      public void processElement(ProcessContext c) throws Exception {
        ...
        if (numSplits <= 0) {
          estimatedNumSplits =
              getEstimatedNumSplits(datastore, options.getProjectId(), options.getDatabaseId(), query, options.getNamespace(), readTime);
        } else {
  ...
  public static class Write extends Mutate<Entity> {
    ...
    public Write withProjectAndDatabaseId(String projectId, String databaseId ) {
      checkArgument(projectId != null, "projectId can not be null");
      return new Write(StaticValueProvider.of(projectId), databaseId, localhost, throttleRampup, hintNumWorkers);
    }
  ...
  private abstract static class Mutate<T> extends PTransform<PCollection<T>, PDone> {
    ...
    public PDone expand(PCollection<T> input) {
      ...
      intermediateOutput.apply(
          "Write Mutation to Datastore", ParDo.of(new DatastoreWriterFn(projectId, databaseId, localhost, new V1DatastoreFactory(), new WriteBatcherImpl())));
  ...
  static class DatastoreWriterFn extends DoFn<Mutation, Void> {
    ...
    DatastoreWriterFn(
      ...
      this(projectId, "", localhost, datastoreFactory, writeBatcher);
    }
    ...
    public void startBundle(StartBundleContext c) {
      // Override Firestore DatabaseID.
      databaseId = c.getPipelineOptions().as(FirestoreOptions.class).getFirestoreDb();
      databaseId = databaseId.equals("(default)")? "": databaseId;

      datastore = datastoreFactory.getDatastore(c.getPipelineOptions(), projectId.get(), databaseId, localhost);
      writeBatcher.start();
  ...
  static class V1DatastoreFactory implements Serializable {
    ...
    public Datastore getDatastore(PipelineOptions pipelineOptions, String projectId, String databaseId) {
    ...
    public Datastore getDatastore(
        PipelineOptions pipelineOptions, String projectId, String databaseId, @Nullable String localhost) {
      ...
      DatastoreOptions.Builder builder =
          new DatastoreOptions.Builder().projectId(projectId).databaseId(databaseId).initializer(initializer);
