...
public class WriteBatcherImpl implements WriteBatcher, Serializable {
    ...
    @VisibleForTesting static final int FIRESTORE_BATCH_UPDATE_ENTITIES_START = 200;
    @VisibleForTesting static final int FIRESTORE_BATCH_UPDATE_ENTITIES_LIMIT = 500;
    @VisibleForTesting static final int FIRESTORE_BATCH_UPDATE_ENTITIES_MIN = 10;
