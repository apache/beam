...
public class LogSegmentUtils {
  ...
  public static LogSegmentMetadataBuilder newBuilder(
      ...
      long logSegmentId,
      long firstTxId) {
    return new LogSegmentMetadataBuilder(path, version, logSegmentId, firstTxId);
  }

  public static LogSegmentMetadata.Mutator newMutator(LogSegmentMetadata segment) {
