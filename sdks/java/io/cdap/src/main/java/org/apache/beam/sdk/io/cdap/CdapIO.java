 ...
 * Plugin#create(Class, Class, Class)} method. Method requires the following parameters:
 *
 * <ul>
 ...
 * HadoopFormatIO}.
 *
 * <p>Every Cdap Plugin has it's {@link PluginConfig} class with necessary fields to configure the
 ...
 *
 * <p>To create the object of the {@link Plugin} class with the {@link Plugin#create(Class, Class,
 * Class)} method, need to specify the following parameters:
 *
 * <ul>
 ...
 *
 * TODO: Describe examples of streaming reading with SparkReceiverIO
 */
