...
public class CallShouldBackoffBasedOnClientRequestRejectionProbabilityTest {

  @Test
  public void testValue() {
    for (Case caze : CASES) {
      CallShouldBackoffBasedOnClientRequestRejectionProbability<String> shouldBackoff = instance();
  ...
  CallShouldBackoffBasedOnClientRequestRejectionProbability<String> instance() {
    return new CallShouldBackoffBasedOnClientRequestRejectionProbability<String>()
        .setThreshold(0.5);
  }
}
