...
class CallShouldBackoffBasedOnClientRequestRejectionProbability<ResponseT>
    implements CallShouldBackoff<ResponseT> {

  // Default value recommended by https://sre.google/sre-book/handling-overload/
  private static final double DEFAULT_MULTIPLIER = 2.0;

  CallShouldBackoffBasedOnClientRequestRejectionProbability() {
    this(DEFAULT_MULTIPLIER);
  }

  CallShouldBackoffBasedOnClientRequestRejectionProbability(double multiplier) {
  ...
  CallShouldBackoffBasedOnClientRequestRejectionProbability<ResponseT> setThreshold(
      double threshold) {
