...
public class SempBasicAuthClientExecutorTest {
     ...
     *       There should be no Authorization header. To simulate an expired session scenario, we
     *       set the response of this request to the "401 Unauthorized". This should cause a the
     *       request to be retried, this time with the Authorization header.
                            ...
                            public LowLevelHttpResponse execute() throws IOException {
                                ...
                                if (requestCounter[0] == 0) {
                                    ...
                                    response.setHeaderNames(
                                                    ImmutableList.of("Set-Cookie", "Set-Cookie"))
                                            .setHeaderValues(
                                                    ImmutableList.of(
