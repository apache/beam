...
public class SolaceIOIT {
    ...
    public void test() {
        ...
        solaceContainerManager.sendToTopic(payload, List.of("Solace-Message-ID:m1"));
        solaceContainerManager.sendToTopic(payload, List.of("Solace-Message-ID:m2"));
        solaceContainerManager.getQueueDetails(queueName);
        ...
        PAssert.thatSingleton(
                        records.apply(
                                "Counting element",
                                Combine.globally(Count.<Record>combineFn()).withoutDefaults()))
                .isEqualTo(1L);
            ...
            public boolean matches(Object item) {
                ...
                boolean partiallyEqual =
                        EqualsBuilder.reflectionEquals(
                                actual, expected, "replicationGroupMessageId");
