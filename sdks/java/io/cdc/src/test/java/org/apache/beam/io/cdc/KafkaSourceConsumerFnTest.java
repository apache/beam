...
class CounterTask extends SourceTask {
    ...
    public List<SourceRecord> poll() throws InterruptedException {
        ...
        while(this.last < this.to) {
            ...
            Map<String, Long> sourceOffset = ImmutableMap.of(
                    "last", this.last.longValue(),
                    "start", this.start
            );

            records.add(new SourceRecord(sourcePartition, sourceOffset, this.topic, Schema.INT64_SCHEMA, this.last));
