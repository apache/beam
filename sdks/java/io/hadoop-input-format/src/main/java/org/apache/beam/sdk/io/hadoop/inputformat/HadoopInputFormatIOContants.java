...
public class HadoopInputFormatIOContants {
  ...
  public static final String WRONG_KEY_TRANSLATIONFUNC_ERROR_MSG =
      "Key translation's input type is not same as hadoop InputFormat : %s key class : %s";
  public static final String WRONG_VALUE_TRANSLATIONFUNC_ERROR_MSG =
  ...
  public static final String COMPUTESPLITS_NULL_SPLITS_ERROR_MSG =
      "Error in computing splits, getSplits() returns null.";
  public static final String COMPUTESPLITS_EMPTY_SPLITS_ERROR_MSG =
      "Error in computing splits, getSplits() returns a empty list";
  public static final String CREATEREADER_UNSPLIT_SOURCE_ERROR_MSG =
      "Cannot create reader as source is not split yet.";
  public static final String CREATEREADER_NULL_SPLIT_ERROR_MSG =
