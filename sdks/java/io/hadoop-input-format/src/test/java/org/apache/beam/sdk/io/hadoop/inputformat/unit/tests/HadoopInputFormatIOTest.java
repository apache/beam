...
public class HadoopInputFormatIOTest {
	...
	public static void setUp() {
		serConf = loadTestConfiguration(NewObjectsEmployeeInputFormat.class,
				Text.class, Employee.class);
	...
	public void testReadBuildsCorrectly() {
		HadoopInputFormatIO.Read<String, String> read = HadoopInputFormatIO
				.<String, String> read()
				.withConfiguration(serConf.getHadoopConfiguration())
				.withKeyTranslation(myKeyTranslate)
				.withValueTranslation(myValueTranslate);
		assertEquals(serConf.getHadoopConfiguration(), read.getConfiguration()
		...
		assertEquals(myValueTranslate.getOutputTypeDescriptor(),
				read.getValueClass());
		assertEquals(myKeyTranslate.getOutputTypeDescriptor(),
				read.getKeyClass());
	}
	...
	public void testReadBuildsCorrectlyInDifferentOrder() {
		HadoopInputFormatIO.Read<String, String> read = HadoopInputFormatIO
				.<String, String> read().withValueTranslation(myValueTranslate)
				.withConfiguration(serConf.getHadoopConfiguration())
				.withKeyTranslation(myKeyTranslate);
		assertEquals(serConf.getHadoopConfiguration(), read.getConfiguration()
				.getHadoopConfiguration());
	...
	public void testReadDisplayData() {
		...
		Iterator<Entry<String, String>> propertyElement = serConf
		...
		assertThat(
				displayData,
				hasDisplayItem("KeyTranslationSimpleFunction",
						myKeyTranslate.toString()));
		assertThat(
				displayData,
				hasDisplayItem("ValueTranslationSimpleFunction",
						myValueTranslate.toString()));
	}

	/**
	 * This test validates Read transform object creation fails with null
	 * configuration. withConfiguration() method checks configuration is null
	 * and throws exception if it is null.
	 */
	@Test
	...
	/**
	 * This test validates Read transform object creation with only
	 * configuration.
	 */
	@Test
	public void testReadObjectCreationWithConfiguration() {
		HadoopInputFormatIO.Read<Text, Employee> read = HadoopInputFormatIO
				.<Text, Employee> read().withConfiguration(
		...
		assertEquals(
				serConf.getHadoopConfiguration().getClass(
						HadoopInputFormatIOContants.KEY_CLASS, Object.class),
				read.getKeyClass().getRawType());
		assertEquals(
				serConf.getHadoopConfiguration().getClass(
						HadoopInputFormatIOContants.VALUE_CLASS, Object.class),
				read.getValueClass().getRawType());

	}

	/**
	 * This test validates Read transform object creation fails with
	 * configuration and null key translation. withKeyTranslation() checks
	 * keyTranslation is null and throws exception if it null value is passed.
	 */
	@Test
	...
	/**
	 * This test validates Read transform object creation with configuration and
	 * key translation.
	 */
	@Test
	public void testReadObjectCreationWithConfigurationKeyTranslation() {
		HadoopInputFormatIO.Read<String, Employee> read = HadoopInputFormatIO
				.<String, Employee> read()
				.withConfiguration(serConf.getHadoopConfiguration())
				.withKeyTranslation(myKeyTranslate);
		read.validate(input);
		assertEquals(serConf.getHadoopConfiguration(), read.getConfiguration()
		...
		assertEquals(myKeyTranslate.getOutputTypeDescriptor().getRawType(),
				read.getKeyClass().getRawType());
		assertEquals(
				serConf.getHadoopConfiguration().getClass("value.class",
						Object.class), read.getValueClass().getRawType());
	}

	/**
	 * This test validates Read transform object creation fails with
	 * configuration and null value translation. withValueTranslation() checks
	...
	public void testReadObjectCreationWithConfigurationValueTranslation() {
		HadoopInputFormatIO.Read<Text, String> read = HadoopInputFormatIO
				.<Text, String> read()
				.withConfiguration(serConf.getHadoopConfiguration())
				.withValueTranslation(myValueTranslate);
		read.validate(input);
		...
		assertEquals(myValueTranslate, read.getValueTranslationFunction());
		assertEquals(
				serConf.getHadoopConfiguration().getClass("key.class",
	...
	/**
	 * This test validates Read transform object creation with configuration ,
	 * key translation and value translation.
	 */
	@Test
	...
	/**
	 * This test validates functionality of Read.validate() function when Read
	 * transform is created without calling withConfiguration().
	 */
	@Test
	...
	/**
	 * This test validates functionality of withConfiguration() function when
	 * Hadoop InputFormat class is not provided by the user in configuration.
	 */
	@Test
	public void testReadValidationFailsMissingInputFormatInConf() {
		Configuration configuration = new Configuration();
		configuration.setClass(HadoopInputFormatIOContants.KEY_CLASS,
				Text.class, Object.class);
		configuration.setClass(HadoopInputFormatIOContants.VALUE_CLASS,
				Employee.class, Object.class);
		thrown.expect(NullPointerException.class);
		thrown.expectMessage(HadoopInputFormatIOContants.MISSING_INPUTFORMAT_ERROR_MSG);
		HadoopInputFormatIO.Read<Text, Employee> read = HadoopInputFormatIO
				.<Text, Employee> read().withConfiguration(configuration);
	}

	/**
	 * This test validates functionality of withConfiguration() function when
	 * key class is not provided by the user in configuration.
	 */
	@Test
	public void testReadValidationFailsMissingKeyClassInConf() {
		Configuration configuration = new Configuration();
		configuration.setClass(
				HadoopInputFormatIOContants.INPUTFORMAT_CLASSNAME,
	...
	/**
	 * This test validates functionality of withConfiguration() function when
	 * value class is not provided by the user in configuration.
	 */
	@Test
	...
	/**
	 * This test validates functionality of Read.validate() function when
	 * myKeyTranslate's (simple function provided by user for key translation)
	 * input type is not same as Hadoop InputFormat's keyClass(Which is property
	 * set in configuration as "key.class").
	 */
	@Test
	public void testReadValidationFailsWithWrongInputTypeKeyTranslationFunction() {
		...
		thrown.expectMessage(String
				.format(HadoopInputFormatIOContants.WRONG_KEY_TRANSLATIONFUNC_ERROR_MSG,
						serConf.getHadoopConfiguration()
								.getClass(
										HadoopInputFormatIOContants.INPUTFORMAT_CLASSNAME,
										InputFormat.class),
						serConf.getHadoopConfiguration().getClass(
								HadoopInputFormatIOContants.KEY_CLASS,
								Object.class)));
		read.validate(input);
	...
	/**
	 * This test validates functionality of Read.validate() function when
	 * myValueTranslate's (simple function provided by user for value
	 * translation) input type is not same as Hadoop InputFormat's
	...
	public void testReadValidationFailsWithWrongInputTypeValueTranslationFunction() {
		...
		String expectedMessage = String
				.format(HadoopInputFormatIOContants.WRONG_VALUE_TRANSLATIONFUNC_ERROR_MSG,
						serConf.getHadoopConfiguration()
								.getClass(
										HadoopInputFormatIOContants.INPUTFORMAT_CLASSNAME,
										InputFormat.class),
						serConf.getHadoopConfiguration().getClass(
								HadoopInputFormatIOContants.VALUE_CLASS,
								Object.class));
		thrown.expect(IllegalArgumentException.class);
	...
	/**
	 * This test validates behavior of HadoopInputFormatSource if RecordReader
	 * object creation fails in start() method.
	 */
	@Test
	public void testReadersStartIfCreateRecordReaderFails() throws Exception {
		SerializableConfiguration serConf = loadTestConfiguration(
				BadCreateReaderInputFormat.class, Text.class, Employee.class);
		HadoopInputFormatBoundedSource<Text, Employee> parentHIFSource = new HadoopInputFormatBoundedSource<Text, Employee>(
				serConf, WritableCoder.of(Text.class),
				AvroCoder.of(Employee.class));
		List<BoundedSource<KV<Text, Employee>>> boundedSourceList = (List<BoundedSource<KV<Text, Employee>>>) parentHIFSource
				.splitIntoBundles(0, p.getOptions());
		for (BoundedSource<KV<Text, Employee>> source : boundedSourceList) {
			BoundedReader<KV<Text, Employee>> reader = source.createReader(p
					.getOptions());
	 ...
	 * createRecordReader() of InputFormat returns null.
	 */
	@Test
	public void testReadersStartWithNullCreateRecordReader() throws Exception {
		SerializableConfiguration serConf = loadTestConfiguration(
				BadNullCreateReaderInputFormat.class, Text.class,
				Employee.class);
		HadoopInputFormatBoundedSource<Text, Employee> parentHIFSource = new HadoopInputFormatBoundedSource<Text, Employee>(
				serConf, WritableCoder.of(Text.class),
				AvroCoder.of(Employee.class));
		...
		for (BoundedSource<KV<Text, Employee>> source : boundedSourceList) {
			...
			thrown.expectMessage(String
					.format(HadoopInputFormatIOContants.NULL_CREATE_RECORDREADER_ERROR_MSG,
	...
	/**
	 * This test validates behavior of createReader() and start() methods if
	 * InputFormat's getSplits() returns InputSplitList having having no
	 * records.
	 */
	@Test
	public void testReadersCreateReaderAndStartWithZeroRecords()
			throws Exception {
		SerializableConfiguration serConf = loadTestConfiguration(
				BadNoRecordsInputFormat.class, java.lang.String.class,
	...
	public void testReadersGetFractionConsumed() throws Exception {
		List<KV<Text, Employee>> referenceRecords = UnitTestUtils
				.getEmployeeData();
		HadoopInputFormatBoundedSource<Text, Employee> parentHIFSource = new HadoopInputFormatBoundedSource<Text, Employee>(
				serConf, WritableCoder.of(Text.class),
				AvroCoder.of(Employee.class));
		long estimatedSize = parentHIFSource.getEstimatedSizeBytes(p
				.getOptions());
		...
		for (BoundedSource<KV<Text, Employee>> source : boundedSourceList) {
			...
			if (start) {
				...
				assertEquals(new Double((float) ++i
						/ UnitTestUtils.NUMBER_OF_RECORDS_IN_EACH_SPLIT),
		...
		assertThat(bundleRecords,
				containsInAnyOrder(referenceRecords.toArray()));
	}

	/**
	 * This test validates that Reader and its parent source reads the same
	 * records.
	 */
	@Test
	public void testReaderAndParentSourceReadsSameData() throws Exception {
		HadoopInputFormatBoundedSource<String, String> parentHIFSource = new HadoopInputFormatBoundedSource<String, String>(
				serConf, StringUtf8Coder.of(), StringUtf8Coder.of(),
				myKeyTranslate, myValueTranslate, null);
		...
		for (BoundedSource<KV<String, String>> source : boundedSourceList) {
			BoundedReader<KV<String, String>> reader = source.createReader(p
					.getOptions());
			SourceTestUtils.assertUnstartedReaderReadsSameAsItsSource(reader,
					p.getOptions());
		}
	}
	 ...
	 * HadoopInputFormatReader.getCurrentSource() returns correct source object.
	 */
	@Test
	public void testGetCurrentSourceFunc() throws Exception {
		...
		List<BoundedSource<KV<String, String>>> boundedSourceList = (List<BoundedSource<KV<String, String>>>) parentHIFSource
				.splitIntoBundles(0, p.getOptions());
		for (BoundedSource<KV<String, String>> source : boundedSourceList) {
			BoundedReader<KV<String, String>> HIFReader = source.createReader(p
					.getOptions());
			BoundedSource<KV<String, String>> HIFSource = HIFReader
					.getCurrentSource();
	...
	/**
	 * This test validates behavior of HadoopInputFormatSource.createReader()
	 * method when HadoopInputFormatSource.splitIntoBundles() is not called.
	 */
	@Test
	...
	/**
	 * This test validates behavior of getEstimatedSizeBytes() and
	 * splitIntoBundles() when Hadoop InputFormat's getSplits() returns empty
	 * list.
	 */
	@Test
	public void testSplitIntoBundlesIfGetSplitsReturnsEmptyList()
			throws Exception {
		SerializableConfiguration serConf = loadTestConfiguration(
				BadEmptySplitsInputFormat.class, Text.class, Employee.class);
		HadoopInputFormatBoundedSource<Text, Employee> parentHIFSource = new HadoopInputFormatBoundedSource<Text, Employee>(
				serConf, WritableCoder.of(Text.class),
				AvroCoder.of(Employee.class));
		thrown.expect(IOException.class);
	...
	/**
	 * This test validates behavior of getEstimatedSizeBytes() and
	 * splitIntoBundles() when Hadoop InputFormat's getSplits() returns NULL
	 * value.
	 */
	@Test
	public void testSplitIntoBundlesIfGetSplitsReturnsNullValue()
			throws Exception {
		SerializableConfiguration serConf = loadTestConfiguration(
				BadNullSplitsInputFormat.class, java.lang.String.class,
				java.lang.String.class);
		HadoopInputFormatBoundedSource<Text, Employee> parentHIFSource = new HadoopInputFormatBoundedSource<Text, Employee>(
				serConf, WritableCoder.of(Text.class),
				AvroCoder.of(Employee.class));
	...
	/**
	 * This test validates functionality of HadoopInputFormatIO if user sets
	 * wrong key class and value class.
	 */
	@Test
	public void testHIFSourceIfUserSetsWrongKeyOrValueClass() throws Exception {
		SerializableConfiguration serConf = loadTestConfiguration(
				NewObjectsEmployeeInputFormat.class, java.lang.String.class,
				java.lang.String.class);
		HadoopInputFormatBoundedSource<String, String> parentHIFSource = new HadoopInputFormatBoundedSource<String, String>(
				serConf, StringUtf8Coder.of(), StringUtf8Coder.of());
		...
		for (BoundedSource<KV<String, String>> source : boundedSourceList) {
			...
			List<KV<String, String>> elems = SourceTestUtils.readFromSource(
					source, p.getOptions());
	...
	/**
	 * This test validates records emitted in PCollection are immutable if
	 * InputFormat's recordReader returns same objects(i.e. same locations in
	 * memory) but with updated values for each record.
	 */
	@Test
	public void testImmutablityOfOutputOfReadIfRecordReaderObjectsAreMutable()
			throws Exception {
		SerializableConfiguration serConf = loadTestConfiguration(
				ReuseObjectsEmployeeInputFormat.class, Text.class,
				Employee.class);
		HadoopInputFormatBoundedSource<Text, Employee> parentHIFSource = new HadoopInputFormatBoundedSource<Text, Employee>(
				serConf, WritableCoder.of(Text.class),
				AvroCoder.of(Employee.class));
		...
		List<KV<Text, Employee>> bundleRecords = new ArrayList<>();
		for (BoundedSource<KV<Text, Employee>> source : boundedSourceList) {
			List<KV<Text, Employee>> elems = SourceTestUtils.readFromSource(
					source, p.getOptions());
			bundleRecords.addAll(elems);
		}
		List<KV<Text, Employee>> referenceRecords = UnitTestUtils
	...
	/**
	 * This test validates records emitted in PCollection are immutable if
	 * InputFormat's recordReader returns different objects (i.e. different
	 * locations in memory).
	 */
	@Test
	public void testImmutablityOfOutputOfReadIfRecordReaderObjectsAreImmutable()
			throws Exception {
		SerializableConfiguration serConf = loadTestConfiguration(
				NewObjectsEmployeeInputFormat.class, Text.class, Employee.class);
		HadoopInputFormatBoundedSource<Text, Employee> parentHIFSource = new HadoopInputFormatBoundedSource<Text, Employee>(
				serConf, WritableCoder.of(Text.class),
				AvroCoder.of(Employee.class));
		List<BoundedSource<KV<Text, Employee>>> boundedSourceList = parentHIFSource
	...
	private static SerializableConfiguration loadTestConfiguration(
			Class<?> inputFormatClassName, Class<?> keyClass,
			Class<?> valueClass) {
		Configuration conf = new Configuration();
		conf.setClass(HadoopInputFormatIOContants.INPUTFORMAT_CLASSNAME,
				inputFormatClassName, InputFormat.class);
		conf.setClass(HadoopInputFormatIOContants.KEY_CLASS, keyClass,
				Object.class);
		conf.setClass(HadoopInputFormatIOContants.VALUE_CLASS, valueClass,
				Object.class);
