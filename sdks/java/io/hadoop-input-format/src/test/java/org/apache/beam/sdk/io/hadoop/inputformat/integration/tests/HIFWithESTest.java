...
public class HIFWithESTest implements Serializable {
  ...
  public void test() throws IOException {
    ...
    conf.setClass("mapred.mapoutput.value.class", valueClass.getRawType(), Object.class);

    SimpleFunction<MapWritable, String> myValueTranslate =
        new SimpleFunction<MapWritable, String>() {
    ...
    /*
     * PCollection<Long> apply = esData.apply(Count.<KV<Text, MapWritable>>globally());
