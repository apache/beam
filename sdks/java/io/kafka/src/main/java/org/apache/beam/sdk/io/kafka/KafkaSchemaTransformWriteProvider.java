...
import org.apache.beam.sdk.io.kafka.KafkaSchemaTransformWriteConfiguration;
 ...
 * using {@link KafkaSchemaTransformWriteConfiguration}.
 *
...
public class KafkaSchemaTransformWriteProvider
    extends TypedSchemaTransformProvider<KafkaSchemaTransformWriteConfiguration> {
  ...
  @Override
  protected Class<KafkaSchemaTransformWriteConfiguration> configurationClass() {
    return KafkaSchemaTransformWriteConfiguration.class;
  }

  /** Returns the expected {@link SchemaTransform} of the configuration. */
  @Override
  protected SchemaTransform from(KafkaSchemaTransformWriteConfiguration configuration) {
   ...
   * KafkaSchemaTransformWriteConfiguration}.
   */
  private static class BigQueryWriteSchemaTransform implements SchemaTransform {
    private final KafkaSchemaTransformWriteConfiguration configuration;

    BigQueryWriteSchemaTransform(KafkaSchemaTransformWriteConfiguration configuration) {
  ...
  static class PCollectionRowTupleTransform
    ...
    PCollectionRowTupleTransform(KafkaSchemaTransformWriteConfiguration configuration) {
      this.configuration = configuration;
    }
