...
public class KafkaIO {
  ...
  public abstract static class Read<K, V>
    ...
    private boolean runnerPrefersLegacyRead(PipelineOptions options) {
      ...
      // TODO(https://github.com/apache/beam/issues/20530): Remove this special check when we address performance issue.
   ...
   * only be used to represent a Kafka record for external transforms. TODO(https://github.com/apache/beam/issues/18919): use
