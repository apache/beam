...
class ShardCheckpoint implements Serializable {
  ...
  public ShardCheckpoint(
      String streamName, String shardId, String consumerArn, StartingPoint startingPoint) {
    this(
        streamName,
        shardId,
        consumerArn,
  ...
  public ShardCheckpoint(
      ...
      Instant timestamp) {
    this(streamName, shardId, consumerArn, shardIteratorType, null, null, timestamp);
  }
