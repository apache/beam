...
public class BasicSnsClientProviderTest {
  ...
  public void testSerialization() {
    ...
    BasicSnsClientProvider snsClientProvider =
        new BasicSnsClientProvider(awsCredentialsProvider, "us-east-1", null);

    byte[] serializedBytes = SerializableUtils.serializeToByteArray(snsClientProvider);

    BasicSnsClientProvider snsClientProviderDeserialized =
