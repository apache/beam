...
public class ConstMap extends ConstValue {
  ...
  public String getValueString() {
    ...
    for (Map.Entry<ConstValue, ConstValue> entry : values.entrySet()) {
      mapString.add(entry.getKey().getValueString() + ":" + entry.getValue().getValueString());
    }
    stringBuilder.append(String.join(",", mapString)).append("}");
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ConstMap)) {
      return false;
    }

    ConstMap c = (ConstMap) o;
