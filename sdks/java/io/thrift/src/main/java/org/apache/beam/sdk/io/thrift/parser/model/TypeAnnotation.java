...
public class TypeAnnotation implements Serializable, Visitable {
  private final String name;
  private final String value;

  public TypeAnnotation(String name, String value) {
    this.name = checkNotNull(name, "name");
    this.value = value; // NOTE: a null value for a type annotation will result in an ANTLR warning.
  }
  ...
  public boolean equals(Object o) {
    ...
    TypeAnnotation c = (TypeAnnotation) o;
