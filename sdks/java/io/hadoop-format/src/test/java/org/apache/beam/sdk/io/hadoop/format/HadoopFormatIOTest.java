...
public class HadoopFormatIOTest {
  ...
  public void testWriteBuildsCorrectly() {
    HadoopFormatIO.Write<Text, Employee> write =
        HadoopFormatIO.<Text, Employee>write().withConfiguration(serConf.get());
   ...
   * null configuration. {@link HadoopFormatIO.Write#withConfiguration(Configuration)
   ...
   * HadoopFormatIO.Write#withConfiguration(Configuration) withConfiguration(Configuration)}
  ...
  public void testWriteValidationFailsMissingOutputFormatInConf() {
    ...
    configuration.setClass(HadoopFormatIO.OUTPUTFORMAT_KEY_CLASS, Text.class, Object.class);
    configuration.setClass(HadoopFormatIO.OUTPUTFORMAT_VALUE_CLASS, Employee.class, Object.class);
    thrown.expect(IllegalArgumentException.class);
  ...
  public void testWriteValidationFailsMissingKeyClassInConf() {
    ...
    configuration.setClass(
        HadoopFormatIO.OUTPUTFORMAT_CLASS, TextOutputFormat.class, OutputFormat.class);
    configuration.setClass(HadoopFormatIO.OUTPUTFORMAT_VALUE_CLASS, Employee.class, Object.class);
    thrown.expect(IllegalArgumentException.class);
  ...
  public void testWritingData() {
    ...
    input.apply("Write", HadoopFormatIO.<Text, Employee>write().withConfiguration(serConf.get()));
    p.run();
  ...
  public void testWritingDataFailInvalidKeyType() {
    ...
    input.apply("Write", HadoopFormatIO.<String, Employee>write().withConfiguration(serConf.get()));
  ...
  public void testWritingDataFailInvalidValueType() {
    ...
    input.apply("Write", HadoopFormatIO.<Text, Text>write().withConfiguration(serConf.get()));
    thrown.expect(Pipeline.PipelineExecutionException.class);
    p.run();
  }
  ...
  public void testWriteDisplayData() {
    HadoopFormatIO.Write<String, String> write =
        HadoopFormatIO.<String, String>write().withConfiguration(serConf.get());
