...
/**
 * TODO: For the purpose of unification of InputFormat and OutputFormat into one common
 * HadoopFormatIO the code of old HadoopInputFormat should be moved to here and HadoopInputFormatIO
 * becomes deprecated in "hadoop-input-format" module.
 *
 * <p>A {@link HadoopFormatIO.Write} is a Transform for writing data to any sink which implements
 * Hadoop {@link OutputFormat}. For example - Cassandra, Elasticsearch, HBase, Redis, Postgres etc.
 * {@link HadoopFormatIO.Write} has to make several performance trade-offs in connecting to {@link
