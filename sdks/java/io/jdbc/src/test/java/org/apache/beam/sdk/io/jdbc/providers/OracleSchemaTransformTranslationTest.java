...
import static org.apache.beam.sdk.io.jdbc.providers.OracleSchemaTransformTranslation.OracleReadSchemaTransformTranslator;
import static org.apache.beam.sdk.io.jdbc.providers.OracleSchemaTransformTranslation.OracleWriteSchemaTransformTranslator;
...
public class OracleSchemaTransformTranslationTest {
  @ClassRule public static final TemporaryFolder TEMPORARY_FOLDER = new TemporaryFolder();

  @Rule public transient ExpectedException thrown = ExpectedException.none();

  static final WriteToOracleSchemaTransformProvider WRITE_PROVIDER =
      new WriteToOracleSchemaTransformProvider();
  static final ReadFromOracleSchemaTransformProvider READ_PROVIDER =
      new ReadFromOracleSchemaTransformProvider();

  static final Row READ_CONFIG =
      Row.withSchema(READ_PROVIDER.configurationSchema())
          .withFieldValue("jdbc_url", "jdbc:oracle:thin:@host:port/database")
  ...
  public void testRecreateWriteTransformFromRow() {
    OracleWriteSchemaTransform writeTransform =
        (OracleWriteSchemaTransform) WRITE_PROVIDER.from(WRITE_CONFIG);
    ...
    OracleWriteSchemaTransform writeTransformFromRow =
  ...
  public void testWriteTransformProtoTranslation()
    ...
    // Then translate the pipeline to a proto and extract OracleWriteSchemaTransform proto
    ...
    // Use the information in the proto to recreate the OracleWriteSchemaTransform
    OracleWriteSchemaTransformTranslator translator = new OracleWriteSchemaTransformTranslator();
    OracleWriteSchemaTransform writeTransformFromSpec =
  ...
  public void testReCreateReadTransformFromRow() {
    ...
    OracleReadSchemaTransform readTransform =
        (OracleReadSchemaTransform) READ_PROVIDER.from(READ_CONFIG);

    OracleReadSchemaTransformTranslator translator = new OracleReadSchemaTransformTranslator();
    Row row = translator.toConfigRow(readTransform);

    OracleReadSchemaTransform readTransformFromRow =
  ...
  public void testReadTransformProtoTranslation()
    ...
    // Then translate the pipeline to a proto and extract OracleReadSchemaTransform proto
    RunnerApi.Pipeline pipelineProto = PipelineTranslation.toProto(p);
    ...
    // Use the information in the proto to recreate the OracleReadSchemaTransform
    OracleReadSchemaTransformTranslator translator = new OracleReadSchemaTransformTranslator();
    OracleReadSchemaTransform readTransformFromSpec =
        translator.fromConfigRow(rowFromSpec, PipelineOptionsFactory.create());
