...
final class Pins {
  ...
  /**
   * Returns the pinned column that forbids relaxing {@code dottedPath} to optional, or null
   * if none does.
   *
   * <p>A pin forbids relaxing the pinned column itself, and also any struct above it.
   *
   * <p>Relaxing a column below a pinned one is allowed.
   */
  @Nullable String forbiddingRelaxationOf(String dottedPath) {
