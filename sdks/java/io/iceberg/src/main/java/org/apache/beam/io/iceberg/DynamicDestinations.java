...
public abstract class DynamicDestinations<T,DestinationT> implements Serializable {
  ...
  public PipelineOptions getOptions() { return options; }

  public List<PCollectionView<?>> getSideInputs() { return Lists.newArrayList(); }
  ...
  public Coder<DestinationT> getDestinationCoder() { return null; }
  ...
  public static class StaticTableDestination<ElementT> extends DynamicDestinations<ElementT,String> {
