...
/**
 * {@link IcebergCdcWriteBaseIT} against a {@link HiveCatalog} backed by an embedded metastore;
...
public class HiveCatalogCdcWriteIT extends IcebergCdcWriteBaseIT {
  ...
  public static void setUpClass() throws MetaException {
    hiveMetastoreExtension = new HiveMetastoreExtension(warehouse(HiveCatalogCdcWriteIT.class));
  }
  ...
  public Map<String, Object> managedIcebergConfig(String tableId) {
    ...
    return ImmutableMap.<String, Object>builder()
        ...
        .put("catalog_properties", ImmutableMap.of("io-impl", ioImplFor(warehouse)))
