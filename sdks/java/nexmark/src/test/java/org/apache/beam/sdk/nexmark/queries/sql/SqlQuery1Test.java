...
public class SqlQuery1Test {
  ...
  private static final Row BID1_EUR_RECORD =
      new Row(BID_ADAPTER.getRecordType(), BID_ADAPTER.getFieldsValues(BID1_EUR));

  private static final Row BID2_EUR_RECORD =
      new Row(BID_ADAPTER.getRecordType(), BID_ADAPTER.getFieldsValues(BID2_EUR));
