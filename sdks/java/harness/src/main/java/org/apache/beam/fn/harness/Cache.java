...
public interface Cache<K, V> {
  ...
  interface Shrinkable<V> {
     ...
     *
     * <p>It is recommended to return an object that is at most half as large as the one being evicted. If {@code null} is returned then the object will be evicted.
     */
    @Nullable V shrink();
  }
