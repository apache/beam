...
public class SplittableSplitAndSizeRestrictionsDoFnRunner<
  ...
  // a "MutableOptional"
  // to hold the present-or-absent value. Ultimately, the root cause is the antipattern of a class
  // where fields
  // are mutated to non-null then back to null, creating sensitive state machine invariants between
  // methods.
