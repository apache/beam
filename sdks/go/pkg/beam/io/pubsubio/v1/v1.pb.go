...
func (PubSubPayload_Op) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_v1_62ac5034291e277a, []int{0, 0}
}
...
func (*PubSubPayload) Descriptor() ([]byte, []int) {
	return fileDescriptor_v1_62ac5034291e277a, []int{0}
}
...
func (dst *PubSubPayload) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PubSubPayload.Merge(dst, src)
}
...
func init() { proto.RegisterFile("v1.proto", fileDescriptor_v1_62ac5034291e277a) }

var fileDescriptor_v1_62ac5034291e277a = []byte{
