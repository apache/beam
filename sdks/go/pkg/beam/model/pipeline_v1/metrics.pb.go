...
const (
	...
	MonitoringInfoSpecs_USER_HISTOGRAM          MonitoringInfoSpecs_Enum = 23
)
...
const (
	...
	MonitoringInfo_PER_WORKER_METRIC MonitoringInfo_MonitoringInfoLabels = 28
)
...
const (
	...
	MonitoringInfoTypeUrns_HISTOGRAM MonitoringInfoTypeUrns_Enum = 13
)
...
type BoundedTrieNode struct {
	...
	Children map[string]*BoundedTrieNode `protobuf:"bytes,2,rep,name=children,proto3" json:"children,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
// Deprecated: Use BoundedTrieNode.ProtoReflect.Descriptor instead.
func (*BoundedTrieNode) Descriptor() ([]byte, []int) {
	return file_org_apache_beam_model_pipeline_v1_metrics_proto_rawDescGZIP(), []int{6}
}
...
// Deprecated: Use BoundedTrie.ProtoReflect.Descriptor instead.
func (*BoundedTrie) Descriptor() ([]byte, []int) {
	return file_org_apache_beam_model_pipeline_v1_metrics_proto_rawDescGZIP(), []int{7}
}
...
type HistogramValue struct {
	...
	BucketOptions *HistogramValue_BucketOptions `protobuf:"bytes,2,opt,name=bucket_options,json=bucketOptions,proto3,oneof" json:"bucket_options,omitempty"`
	...
	BucketCounts []int64 `protobuf:"varint,3,rep,packed,name=bucket_counts,json=bucketCounts,proto3" json:"bucket_counts,omitempty"`
}

func (x *HistogramValue) Reset() {
	*x = HistogramValue{}
	if protoimpl.UnsafeEnabled {
		mi := &file_org_apache_beam_model_pipeline_v1_metrics_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HistogramValue) Descriptor() ([]byte, []int) {
	return file_org_apache_beam_model_pipeline_v1_metrics_proto_rawDescGZIP(), []int{8}
}
...
func (x *HistogramValue) GetBucketOptions() *HistogramValue_BucketOptions {
	if x != nil {
...
type HistogramValue_BucketOptions struct {
	...
	// Types that are assignable to BucketType:
	//
	//	*HistogramValue_BucketOptions_Linear_
	//	*HistogramValue_BucketOptions_Exponential
	BucketType isHistogramValue_BucketOptions_BucketType `protobuf_oneof:"bucket_type"`
}

func (x *HistogramValue_BucketOptions) Reset() {
	*x = HistogramValue_BucketOptions{}
	if protoimpl.UnsafeEnabled {
		mi := &file_org_apache_beam_model_pipeline_v1_metrics_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *HistogramValue_BucketOptions) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HistogramValue_BucketOptions) ProtoMessage() {}

func (x *HistogramValue_BucketOptions) ProtoReflect() protoreflect.Message {
	mi := &file_org_apache_beam_model_pipeline_v1_metrics_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HistogramValue_BucketOptions.ProtoReflect.Descriptor instead.
func (*HistogramValue_BucketOptions) Descriptor() ([]byte, []int) {
	return file_org_apache_beam_model_pipeline_v1_metrics_proto_rawDescGZIP(), []int{8, 0}
}

func (m *HistogramValue_BucketOptions) GetBucketType() isHistogramValue_BucketOptions_BucketType {
	if m != nil {
		return m.BucketType
	}
	return nil
...
func (x *HistogramValue_BucketOptions) GetLinear() *HistogramValue_BucketOptions_Linear {
	if x, ok := x.GetBucketType().(*HistogramValue_BucketOptions_Linear_); ok {
		return x.Linear
	}
	return nil
}

func (x *HistogramValue_BucketOptions) GetExponential() *HistogramValue_BucketOptions_Base2Exponent {
	if x, ok := x.GetBucketType().(*HistogramValue_BucketOptions_Exponential); ok {
		return x.Exponential
	}
	return nil
}

type isHistogramValue_BucketOptions_BucketType interface {
	isHistogramValue_BucketOptions_BucketType()
}

type HistogramValue_BucketOptions_Linear_ struct {
	// Bucket boundaries grow linearly.
	Linear *HistogramValue_BucketOptions_Linear `protobuf:"bytes,1,opt,name=linear,proto3,oneof"`
}

type HistogramValue_BucketOptions_Exponential struct {
	// Bucket boundaries grow exponentially.
	Exponential *HistogramValue_BucketOptions_Base2Exponent `protobuf:"bytes,2,opt,name=exponential,proto3,oneof"`
}

func (*HistogramValue_BucketOptions_Linear_) isHistogramValue_BucketOptions_BucketType() {}

func (*HistogramValue_BucketOptions_Exponential) isHistogramValue_BucketOptions_BucketType() {}

// Linear buckets with the following boundaries for indices in 0 to n-1.
// - i in [0, n-1]:  [start + (i)*width, start + (i+1)*width)
type HistogramValue_BucketOptions_Linear struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//	`bucket_counts` field --)
	NumberOfBuckets *int32 `protobuf:"varint,1,opt,name=number_of_buckets,json=numberOfBuckets,proto3,oneof" json:"number_of_buckets,omitempty"`
	...
	Start *float64 `protobuf:"fixed64,3,opt,name=start,proto3,oneof" json:"start,omitempty"`
}

func (x *HistogramValue_BucketOptions_Linear) Reset() {
	*x = HistogramValue_BucketOptions_Linear{}
	if protoimpl.UnsafeEnabled {
		mi := &file_org_apache_beam_model_pipeline_v1_metrics_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *HistogramValue_BucketOptions_Linear) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HistogramValue_BucketOptions_Linear) ProtoMessage() {}

func (x *HistogramValue_BucketOptions_Linear) ProtoReflect() protoreflect.Message {
	mi := &file_org_apache_beam_model_pipeline_v1_metrics_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HistogramValue_BucketOptions_Linear.ProtoReflect.Descriptor instead.
func (*HistogramValue_BucketOptions_Linear) Descriptor() ([]byte, []int) {
	return file_org_apache_beam_model_pipeline_v1_metrics_proto_rawDescGZIP(), []int{8, 0, 0}
}

func (x *HistogramValue_BucketOptions_Linear) GetNumberOfBuckets() int32 {
	if x != nil && x.NumberOfBuckets != nil {
		return *x.NumberOfBuckets
	}
	return 0
}

func (x *HistogramValue_BucketOptions_Linear) GetWidth() float64 {
...
func (x *HistogramValue_BucketOptions_Linear) GetStart() float64 {
...
type HistogramValue_BucketOptions_Base2Exponent struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *HistogramValue_BucketOptions_Base2Exponent) Reset() {
	*x = HistogramValue_BucketOptions_Base2Exponent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_org_apache_beam_model_pipeline_v1_metrics_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *HistogramValue_BucketOptions_Base2Exponent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HistogramValue_BucketOptions_Base2Exponent) ProtoMessage() {}

func (x *HistogramValue_BucketOptions_Base2Exponent) ProtoReflect() protoreflect.Message {
	mi := &file_org_apache_beam_model_pipeline_v1_metrics_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HistogramValue_BucketOptions_Base2Exponent.ProtoReflect.Descriptor instead.
func (*HistogramValue_BucketOptions_Base2Exponent) Descriptor() ([]byte, []int) {
	return file_org_apache_beam_model_pipeline_v1_metrics_proto_rawDescGZIP(), []int{8, 0, 1}
}

func (x *HistogramValue_BucketOptions_Base2Exponent) GetNumberOfBuckets() int32 {
	if x != nil && x.NumberOfBuckets != nil {
		return *x.NumberOfBuckets
	}
	return 0
...
func (x *HistogramValue_BucketOptions_Base2Exponent) GetScale() int32 {
...
var file_org_apache_beam_model_pipeline_v1_metrics_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0xec, 0x27,
	0x0a, 0x13, 0x4d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f,
	0x53, 0x70, 0x65, 0x63, 0x73, 0x22, 0xd4, 0x27, 0x0a, 0x04, 0x45, 0x6e, 0x75, 0x6d, 0x12, 0xa7,
	...
	,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x49, 0x6e,
	0x66, 0x6f, 0x2e, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x06,
	0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x12, 0x39, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x72, 0x74, 0x5f,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_org_apache_beam_model_pipeline_v1_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_org_apache_beam_model_pipeline_v1_metrics_proto_goTypes = []interface{}{
	...
	(*HistogramValue)(nil),                             // 11: org.apache.beam.model.pipeline.v1.HistogramValue
	nil,                                                // 12: org.apache.beam.model.pipeline.v1.MonitoringInfo.LabelsEntry
	nil,                                                // 13: org.apache.beam.model.pipeline.v1.BoundedTrieNode.ChildrenEntry
	(*HistogramValue_BucketOptions)(nil),               // 14: org.apache.beam.model.pipeline.v1.HistogramValue.BucketOptions
	(*HistogramValue_BucketOptions_Linear)(nil),        // 15: org.apache.beam.model.pipeline.v1.HistogramValue.BucketOptions.Linear
	(*HistogramValue_BucketOptions_Base2Exponent)(nil), // 16: org.apache.beam.model.pipeline.v1.HistogramValue.BucketOptions.Base2Exponent
...
var file_org_apache_beam_model_pipeline_v1_metrics_proto_depIdxs = []int32{
	...
	12, // 1: org.apache.beam.model.pipeline.v1.MonitoringInfo.labels:type_name -> org.apache.beam.model.pipeline.v1.MonitoringInfo.LabelsEntry
	17, // 2: org.apache.beam.model.pipeline.v1.MonitoringInfo.start_time:type_name -> google.protobuf.Timestamp
	13, // 3: org.apache.beam.model.pipeline.v1.BoundedTrieNode.children:type_name -> org.apache.beam.model.pipeline.v1.BoundedTrieNode.ChildrenEntry
	9,  // 4: org.apache.beam.model.pipeline.v1.BoundedTrie.root:type_name -> org.apache.beam.model.pipeline.v1.BoundedTrieNode
	14, // 5: org.apache.beam.model.pipeline.v1.HistogramValue.bucket_options:type_name -> org.apache.beam.model.pipeline.v1.HistogramValue.BucketOptions
	9,  // 6: org.apache.beam.model.pipeline.v1.BoundedTrieNode.ChildrenEntry.value:type_name -> org.apache.beam.model.pipeline.v1.BoundedTrieNode
	15, // 7: org.apache.beam.model.pipeline.v1.HistogramValue.BucketOptions.linear:type_name -> org.apache.beam.model.pipeline.v1.HistogramValue.BucketOptions.Linear
	16, // 8: org.apache.beam.model.pipeline.v1.HistogramValue.BucketOptions.exponential:type_name -> org.apache.beam.model.pipeline.v1.HistogramValue.BucketOptions.Base2Exponent
	18, // 9: org.apache.beam.model.pipeline.v1.label_props:extendee -> google.protobuf.EnumValueOptions
	18, // 10: org.apache.beam.model.pipeline.v1.monitoring_info_spec:extendee -> google.protobuf.EnumValueOptions
	6,  // 11: org.apache.beam.model.pipeline.v1.label_props:type_name -> org.apache.beam.model.pipeline.v1.MonitoringInfoLabelProps
	3,  // 12: org.apache.beam.model.pipeline.v1.monitoring_info_spec:type_name -> org.apache.beam.model.pipeline.v1.MonitoringInfoSpec
...
func file_org_apache_beam_model_pipeline_v1_metrics_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_org_apache_beam_model_pipeline_v1_metrics_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BoundedTrieNode); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_org_apache_beam_model_pipeline_v1_metrics_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BoundedTrie); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_org_apache_beam_model_pipeline_v1_metrics_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_org_apache_beam_model_pipeline_v1_metrics_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HistogramValue_BucketOptions); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_org_apache_beam_model_pipeline_v1_metrics_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HistogramValue_BucketOptions_Linear); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_org_apache_beam_model_pipeline_v1_metrics_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HistogramValue_BucketOptions_Base2Exponent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_org_apache_beam_model_pipeline_v1_metrics_proto_msgTypes[8].OneofWrappers = []interface{}{}
	file_org_apache_beam_model_pipeline_v1_metrics_proto_msgTypes[11].OneofWrappers = []interface{}{
		(*HistogramValue_BucketOptions_Linear_)(nil),
		(*HistogramValue_BucketOptions_Exponential)(nil),
	}
	file_org_apache_beam_model_pipeline_v1_metrics_proto_msgTypes[12].OneofWrappers = []interface{}{}
	file_org_apache_beam_model_pipeline_v1_metrics_proto_msgTypes[13].OneofWrappers = []interface{}{}
	type x struct{}
