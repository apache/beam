...
type GlobalWindowsPayload_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

}

func (b0 GlobalWindowsPayload_builder) Build() *GlobalWindowsPayload {
	m0 := &GlobalWindowsPayload{}
	b, x := &b0, m0
	_, _ = b, x
	return m0
}
...
type FixedWindowsPayload_builder struct {
	...
	// (Required) Represents the size of the window.
	Size *durationpb.Duration
	// (Required) Represents the timestamp of when the first window begins.
	// Window N will start at offset + N * size.
	Offset *timestamppb.Timestamp
}

func (b0 FixedWindowsPayload_builder) Build() *FixedWindowsPayload {
...
func (b0 SlidingWindowsPayload_builder) Build() *SlidingWindowsPayload {
...
type SessionWindowsPayload_builder struct {
	...
	// (Required) Minimum duration of gaps between sessions.
	GapSize *durationpb.Duration
}

func (b0 SessionWindowsPayload_builder) Build() *SessionWindowsPayload {
...
var file_org_apache_beam_model_pipeline_v1_standard_window_fns_proto_goTypes = []any{
