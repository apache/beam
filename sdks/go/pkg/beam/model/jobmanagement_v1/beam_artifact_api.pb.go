...
func (b0 ResolveArtifactsRequest_builder) Build() *ResolveArtifactsRequest {
...
func (b0 ResolveArtifactsResponse_builder) Build() *ResolveArtifactsResponse {
...
func (b0 GetArtifactRequest_builder) Build() *GetArtifactRequest {
...
func (x *GetArtifactResponse) SetData(v []byte) {
	if v == nil {
		v = []byte{}
	}
	x.Data = v
...
func (b0 GetArtifactResponse_builder) Build() *GetArtifactResponse {
...
func (x *ArtifactRequestWrapper) HasGetArtifact() bool {
	if x == nil {
		return false
	}
...
const ArtifactRequestWrapper_Request_not_set_case case_ArtifactRequestWrapper_Request = 0
const ArtifactRequestWrapper_ResolveArtifact_case case_ArtifactRequestWrapper_Request = 1000
const ArtifactRequestWrapper_GetArtifact_case case_ArtifactRequestWrapper_Request = 1001

func (x *ArtifactRequestWrapper) WhichRequest() case_ArtifactRequestWrapper_Request {
	if x == nil {
...
type case_ArtifactRequestWrapper_Request protoreflect.FieldNumber

func (x case_ArtifactRequestWrapper_Request) String() string {
	md := file_org_apache_beam_model_job_management_v1_beam_artifact_api_proto_msgTypes[4].Descriptor()
	if x == 0 {
		return "not set"
	}
...
func (x *ArtifactResponseWrapper) HasGetArtifactResponse() bool {
	if x == nil {
		return false
	}
...
const ArtifactResponseWrapper_Response_not_set_case case_ArtifactResponseWrapper_Response = 0
const ArtifactResponseWrapper_ResolveArtifactResponse_case case_ArtifactResponseWrapper_Response = 1000
const ArtifactResponseWrapper_GetArtifactResponse_case case_ArtifactResponseWrapper_Response = 1001

func (x *ArtifactResponseWrapper) WhichResponse() case_ArtifactResponseWrapper_Response {
	if x == nil {
...
type ArtifactResponseWrapper_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.
...
type case_ArtifactResponseWrapper_Response protoreflect.FieldNumber

func (x case_ArtifactResponseWrapper_Response) String() string {
	md := file_org_apache_beam_model_job_management_v1_beam_artifact_api_proto_msgTypes[5].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
func (b0 ArtifactMetadata_builder) Build() *ArtifactMetadata {
	m0 := &ArtifactMetadata{}
	b, x := &b0, m0
	_, _ = b, x
	x.Name = b.Name
...
func (b0 ProxyManifest_builder) Build() *ProxyManifest {
	m0 := &ProxyManifest{}
	b, x := &b0, m0
	_, _ = b, x
...
func (b0 GetManifestRequest_builder) Build() *GetManifestRequest {
...
func (b0 GetManifestResponse_builder) Build() *GetManifestResponse {
...
func (b0 LegacyGetArtifactRequest_builder) Build() *LegacyGetArtifactRequest {
...
func (b0 PutArtifactMetadata_builder) Build() *PutArtifactMetadata {
...
func (x *PutArtifactRequest) HasData() bool {
	if x == nil {
		return false
	}
...
const PutArtifactRequest_Content_not_set_case case_PutArtifactRequest_Content = 0
const PutArtifactRequest_Metadata_case case_PutArtifactRequest_Content = 1
const PutArtifactRequest_Data_case case_PutArtifactRequest_Content = 2

func (x *PutArtifactRequest) WhichContent() case_PutArtifactRequest_Content {
	if x == nil {
...
type PutArtifactRequest_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.
...
type case_PutArtifactRequest_Content protoreflect.FieldNumber

func (x case_PutArtifactRequest_Content) String() string {
	md := file_org_apache_beam_model_job_management_v1_beam_artifact_api_proto_msgTypes[14].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
type PutArtifactResponse_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

}

func (b0 PutArtifactResponse_builder) Build() *PutArtifactResponse {
	m0 := &PutArtifactResponse{}
	b, x := &b0, m0
	_, _ = b, x
	return m0
}
...
func (b0 CommitManifestRequest_builder) Build() *CommitManifestRequest {
...
func (b0 CommitManifestResponse_builder) Build() *CommitManifestResponse {
...
func (b0 ProxyManifest_Location_builder) Build() *ProxyManifest_Location {
...
var file_org_apache_beam_model_job_management_v1_beam_artifact_api_proto_goTypes = []any{
