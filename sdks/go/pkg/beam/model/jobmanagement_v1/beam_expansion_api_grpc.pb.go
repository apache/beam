...
// UnimplementedExpansionServiceServer must be embedded to have
...
func (UnimplementedExpansionServiceServer) testEmbeddedByValue()                          {}
...
func RegisterExpansionServiceServer(s grpc.ServiceRegistrar, srv ExpansionServiceServer) {
	// If the following call pancis, it indicates UnimplementedExpansionServiceServer was
