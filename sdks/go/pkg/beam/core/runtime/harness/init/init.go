...
var (
	...
	runnerCapabilities = flag.String("runner_capabilities", "", "comma separated list of runner capabilities (optional in worker mode).")
)
...
func hook() {
	...
	if err := harness.Main(ctx, *loggingEndpoint, *controlEndpoint, harness.StatusAddress(*statusEndpoint), harness.RunnerCapabilities(*runnerCapabilities)); err != nil {
