...
type Combine struct {
	...
	mergeFn Caller // optimized caller in the case of binary merge accumulators
...
func (n *Combine) Up(ctx context.Context) error {
	...
	n.mergeFn = makeCaller(n.Edge.CombineFn.MergeAccumulatorsFn().Fn)
...
func (n *Combine) addInput(ctx context.Context, accum, key, value reflect.Value, timestamp typex.EventTime, first bool) (reflect.Value, error) {
	...
	if fn == nil {
		...
		vals := n.mergeFn.Call([]reflect.Value{a, b})
		return vals[0], nil
	}
