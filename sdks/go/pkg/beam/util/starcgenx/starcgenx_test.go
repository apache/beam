...
func TestExtractor(t *testing.T) {
	tests := []struct {
		...
		{name: "excludedtypes", files: []string{excludedtypes}, pkg: "excludedtypes", imports: []string{"beam.apache.org/sdks/go/pkg/beam"},
		...
		{name: "registerDoFn", files: []string{pardo, registerDoFn}, pkg: "pardo", imports: []string{"beam.apache.org/sdks/go/pkg/beam"},
