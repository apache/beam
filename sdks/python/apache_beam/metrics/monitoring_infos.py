...
ELEMENT_COUNT_URN = common_urns.monitoring_info_specs.ELEMENT_COUNT.urn
START_BUNDLE_MSECS_URN = common_urns.monitoring_info_specs.START_BUNDLE_MSECS.urn
PROCESS_BUNDLE_MSECS_URN = common_urns.monitoring_info_specs.PROCESS_BUNDLE_MSECS.urn
FINISH_BUNDLE_MSECS_URN = common_urns.monitoring_info_specs.FINISH_BUNDLE_MSECS.urn
TOTAL_MSECS_URN = common_urns.monitoring_info_specs.TOTAL_MSECS.urn
USER_COUNTER_URN_PREFIX = (
    common_urns.monitoring_info_specs.USER_COUNTER.urn)
USER_DISTRIBUTION_COUNTER_URN_PREFIX = (
    common_urns.monitoring_info_specs.USER_DISTRIBUTION_COUNTER.urn)
