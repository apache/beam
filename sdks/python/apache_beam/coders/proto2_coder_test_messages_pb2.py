...
field1 = _descriptor.FieldDescriptor(
    name='field1',
    full_name='proto2_coder_test_messages.field1',
    index=0,
    number=101,
    type=11,
    cpp_type=10,
...
field2 = _descriptor.FieldDescriptor(
    name='field2',
    full_name='proto2_coder_test_messages.field2',
    index=1,
    number=102,
    type=11,
    cpp_type=10,
...
_MESSAGEA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='field1',
            full_name='proto2_coder_test_messages.MessageA.field1',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='field2',
            full_name='proto2_coder_test_messages.MessageA.field2',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_MESSAGEB = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='field1',
            full_name='proto2_coder_test_messages.MessageB.field1',
            index=0,
            number=1,
            type=8,
            cpp_type=7,
...
_MESSAGEWITHMAP_FIELD1ENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key',
            full_name='proto2_coder_test_messages.MessageWithMap.Field1Entry.key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_MESSAGEWITHMAP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='field1',
            full_name='proto2_coder_test_messages.MessageWithMap.field1',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_REFERENCESMESSAGEWITHMAP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='field1',
            full_name='proto2_coder_test_messages.ReferencesMessageWithMap.field1',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_MESSAGEWITHMAP.fields_by_name[
    'field1'
].message_type = _MESSAGEWITHMAP_FIELD1ENTRY
_REFERENCESMESSAGEWITHMAP.fields_by_name[
    'field1'
].message_type = _MESSAGEWITHMAP
...
MessageC = _reflection.GeneratedProtocolMessageType(
    'MessageC',
    (_message.Message,),
    dict(
...
MessageWithMap = _reflection.GeneratedProtocolMessageType(
    'MessageWithMap',
    (_message.Message,),
    dict(
        Field1Entry=_reflection.GeneratedProtocolMessageType(
            'Field1Entry',
            (_message.Message,),
            dict(
...
ReferencesMessageWithMap = _reflection.GeneratedProtocolMessageType(
    'ReferencesMessageWithMap',
    (_message.Message,),
    dict(
...
_MESSAGEWITHMAP_FIELD1ENTRY._options = _descriptor._ParseOptions(
    descriptor_pb2.MessageOptions(), _b('8\001'))
