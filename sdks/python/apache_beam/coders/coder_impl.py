...
class TimerCoderImpl(StreamCoderImpl):
  ...
  def encode_to_stream(
      self, value: userstate.Timer, out: create_OutputStream,
      nested: bool) -> None:
  ...
  def decode_from_stream(
      self, in_stream: create_InputStream, nested: bool) -> userstate.Timer:
    from apache_beam.transforms import userstate
...
class ShardedKeyCoderImpl(StreamCoderImpl):
  ...
  def encode_to_stream(
      self, value: ShardedKey, out: create_OutputStream, nested: bool) -> None:
  ...
  def decode_from_stream(
      self, in_stream: create_InputStream, nested: bool) -> ShardedKey:
