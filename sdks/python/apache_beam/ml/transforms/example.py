...
from apache_beam.ml.transforms.embeddings.tensorflow_hub import TensorflowHubEmbeddings
...
def run_tensorflow_hub_embedding(pipeline_args):
  ...
  embedding_config = TensorflowHubEmbeddings(
      columns=['text'],
      hub_url=model_uri,
...
# def run_pipelien(pipeline_args):
