...
class SentenceTrasformerEmbeddingsTest(unittest.TestCase):
  ...
  #     (
  #     result_pcoll
  #     | beam.Map(lambda x: self.assertTrue(len(x[test_query_column]) == 768))
  #   )
  ...
  #     (
  #       transformed_pcoll
  #       | beam.Map(lambda x: self.assertTrue(max(x.feature_1) == 1))
  #     )

  # def pipeline_with_configurable_artifact_location(self,
  #   pipeline,
  ...
  #         #  0.1342099905014038
  #         | beam.Map(lambda x: self.assertTrue(round(x, 2) == 0.13))
  #       )
