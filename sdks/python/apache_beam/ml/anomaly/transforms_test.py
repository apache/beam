...
_PreProcessingModelHandler = specifiable(_PreProcessingModelHandler)  # type: ignore
_PostProcessingModelHandler = specifiable(_PostProcessingModelHandler)  # type: ignore
