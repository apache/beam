...
@unittest.skipIf(sys.platform == 'win32', '[Issue 20361]')
  ...
  def test_dataframe_tests(self):
    result = doctests.testmod(
        ...
        skip={
            ...
            'pandas.core.frame.DataFrame.set_index': [
                # TODO(Issue 20759): This could pass in the index as
  ...
  def test_series_tests(self):
    result = doctests.testmod(
        ...
        skip={
            ...
            'pandas.core.series.Series.groupby': [
                # TODO(Issue 20643): This example requires aligning two series
  ...
  def test_datetime_tests(self):
    ...
    indexes_accessors_result = doctests.testmod(
        ...
        skip={
            ...
            # TODO(Issue 21013): Test data creation fails for these
