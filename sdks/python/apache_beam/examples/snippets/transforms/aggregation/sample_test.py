...
@mock.patch(
    'apache_beam.examples.snippets.transforms.aggregation.sample_fixed_size_globally.print', str)
@mock.patch(
    'apache_beam.examples.snippets.transforms.aggregation.sample_fixed_size_per_key.print', str)
