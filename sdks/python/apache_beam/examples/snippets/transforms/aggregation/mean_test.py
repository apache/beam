...
@mock.patch(
    'apache_beam.examples.snippets.transforms.aggregation.mean_globally.print', str)
@mock.patch(
    'apache_beam.examples.snippets.transforms.aggregation.mean_per_key.print', str)
