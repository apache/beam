...
from apache_beam.ml.inference.huggingface_inference import HuggingFaceModelHandlerNumpy
...
def parse_known_args(argv):
  ...
  parser.add_argument(
      ...
      dest='repo_id',
      required=True,
      help='Name of the repository containing pre-trained model.')
  parser.add_argument(
      '--filename',
      dest='filename',
      required=True,
...
def run(
  ...
  model_loader = HuggingFaceModelHandlerNumpy(
      repo_id=known_args.repo_id,
      filename=known_args.filename).with_preprocess_fn(
