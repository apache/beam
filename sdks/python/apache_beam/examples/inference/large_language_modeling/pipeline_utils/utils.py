...
class Preprocess(beam.DoFn):
    ...
    def process(self, element):
        """
        Process the raw text input to a format suitable for T5ForConditionalGeneration Model Inference
...
class Postprocess(beam.DoFn):
    ...
    def process(self, element):
        """
        Process the PredictionResult to print the generated translated texts
