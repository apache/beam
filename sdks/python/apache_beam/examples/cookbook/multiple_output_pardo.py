...
#   description: This is a slightly modified version of the
#       basic wordcount example. In this example words are divided into 2 buckets
#       as shorts words (3 characters in length or less) and words (other).
