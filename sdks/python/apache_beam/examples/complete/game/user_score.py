...
# beam-playground:
#   name: UserScore
#   description: batch processing; reading input from Google Cloud Storage or a from a local text file, and writing
#     output to a text file; using standalone DoFns; use of the CombinePerKey transform.
#   multifile: true
