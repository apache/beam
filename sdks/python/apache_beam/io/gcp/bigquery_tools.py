...
# -----------------------------------------------------------------------------
# Compatibility Layer (imported from bigquery_compat)
#
# All compatibility models, conversion helpers, and emulated legacy apitools
# client classes are isolated in bigquery_compat.py for easy deprecation
# and removal in a future Beam release when apitools is dropped.
# -----------------------------------------------------------------------------
from apache_beam.io.gcp.bigquery_compat import Dataset
from apache_beam.io.gcp.bigquery_compat import DatasetReference
from apache_beam.io.gcp.bigquery_compat import ErrorProto
from apache_beam.io.gcp.bigquery_compat import Job
from apache_beam.io.gcp.bigquery_compat import JobConfiguration
from apache_beam.io.gcp.bigquery_compat import JobConfigurationExtract
from apache_beam.io.gcp.bigquery_compat import JobConfigurationLoad
from apache_beam.io.gcp.bigquery_compat import JobConfigurationQuery
from apache_beam.io.gcp.bigquery_compat import JobConfigurationTableCopy
from apache_beam.io.gcp.bigquery_compat import JobReference
from apache_beam.io.gcp.bigquery_compat import JobStatistics
from apache_beam.io.gcp.bigquery_compat import JobStatistics2
from apache_beam.io.gcp.bigquery_compat import JobStatistics4
from apache_beam.io.gcp.bigquery_compat import Table
from apache_beam.io.gcp.bigquery_compat import TableCell
from apache_beam.io.gcp.bigquery_compat import TableFieldSchema
from apache_beam.io.gcp.bigquery_compat import TableReference
from apache_beam.io.gcp.bigquery_compat import TableRow
from apache_beam.io.gcp.bigquery_compat import TableSchema
from apache_beam.io.gcp.bigquery_compat import _ClientDatasetsCompat
from apache_beam.io.gcp.bigquery_compat import _ClientJobsCompat
from apache_beam.io.gcp.bigquery_compat import _ClientTablesCompat
from apache_beam.io.gcp.bigquery_compat import _DatasetReferenceCompat
from apache_beam.io.gcp.bigquery_compat import _extract_dict_labels
from apache_beam.io.gcp.bigquery_compat import _JobStatsCompat
from apache_beam.io.gcp.bigquery_compat import _JobStatusCompat
from apache_beam.io.gcp.bigquery_compat import _TableCellCompat
from apache_beam.io.gcp.bigquery_compat import _TableFieldSchemaCompat
