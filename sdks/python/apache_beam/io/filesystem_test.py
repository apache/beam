  ...
  @parameterized.expand(
      [
          ...
          (
              ...
              [('cow/cat/fish', 2), ('cow/cat/blubber', 3)],
          ),
          (
          ...
          (
              ...
              [('apple/dish/bat', 13), ('apple/dish/cat', 14)],
          ),
          (
              'gs://gcsio-test/banana/cyrano.m?',
              [('banana/cyrano.md', 17), ('banana/cyrano.mb', 18)],
          ),
      ])
  ...
  def _create_compressed_file(self, compression_type, content):
    ...
    if compression_type == CompressionTypes.DEFLATE:
      with open(file_name, 'wb') as f:
        ...
        or compression_type == CompressionTypes.GZIP):
      compress_open = (
          bz2.BZ2File
