...
class ReadFromAvro(PTransform):
  ...
  def __init__(self, file_pattern=None, min_bundle_size=0, validate=True):
    ...
    Then records generated by ``_AvroSource`` will be dictionaries of the
    following form. ::

      {u'name': u'Alyssa', u'favorite_number': 256, u'favorite_color': None}).

    Args:
      file_pattern (:class:`str`): the file glob to read a string
      min_bundle_size (:class:`int`): the minimum size in bytes, to be
        considered when splitting the input into bundles.
