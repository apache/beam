...
class ReadFromAvro(PTransform):
  ...
  def __init__(self, file_pattern=None, min_bundle_size=0, validate=True):
    ...
    Then records generated by ``ReadFromAvro`` will be dictionaries of the
    following form.
...
class ReadAllFromAvro(PTransform):
  ...
  def __init__(self, min_bundle_size=0,
   ...
   Each record of the output ``PCollection`` will contain a single record read
   from a source. Records that are of simple types will be mapped into
   ...
   For example, if schema of the Avro file is the following.
     ...
     [{"name": "name", "type": "string"},
      {"name": "favorite_number",  "type": ["int", "null"]},
      {"name": "favorite_color", "type": ["string", "null"]}]}
   Then records generated by ``ReadAllFromAvro`` will be dictionaries of the
   following form.
     {u'name': u'Alyssa', u'favorite_number': 256, u'favorite_color': None}).
