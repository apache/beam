...
class CrossLanguageJdbcIOTest(unittest.TestCase):
  ...
  def test_xlang_jdbc_write(self, database):
    ...
    with TestPipeline() as p:
      ...
      _ = (
          ...
          # TODO(https://github.com/apache/beam/issues/20446) Add test with overridden write_statement
  ...
  def test_xlang_jdbc_read(self, database):
    ...
    with TestPipeline() as p:
      ...
      result = (
          p
          # TODO(https://github.com/apache/beam/issues/20446) Add test with overridden read_query
