...
class CrossLanguageKinesisIOTest(unittest.TestCase):
  ...
  def test_kinesis_io_roundtrip(self):
    # TODO: enable this test for localstack once https://github.com/apache/beam/issues/20416 is resolved
  ...
  def test_kinesis_write(self):
    # TODO: remove this test once https://github.com/apache/beam/issues/20416 is resolved
    self.run_kinesis_write()
