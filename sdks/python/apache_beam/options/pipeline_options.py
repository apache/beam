...
class PrismRunnerOptions(PipelineOptions):
  ...
  def _add_argparse_args(cls, parser):
    ...
    parser.add_argument(
        '--prism_location',
        help=
        'Path or URL to a prism binary, or zipped binary for the current platform (Operating System and Architecture).'
    ...
    parser.add_argument(
        ...
        help=
        'Override the SDK\'s version for deriving the Github Release URLs for downloading a zipped prism binary,'
