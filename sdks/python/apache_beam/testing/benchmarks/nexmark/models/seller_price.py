...
class SellerPriceCoder(FastCoder):
  def _create_impl(self):
    return SellerPriceCoderImpl()

  def is_deterministic(self):
    return True


class SellerPrice(object):
  CODER = SellerPriceCoder()
...
class SellerPriceCoderImpl(coder_impl.StreamCoderImpl):
  ...
  def decode_from_stream(self, stream, nested):
    ...
    return SellerPrice(seller, price)
