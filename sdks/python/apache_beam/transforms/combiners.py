  ...
  class PerElement(ptransform.PTransform):
    ...
    def expand(self, pcoll):
      ...
      return (
          pcoll
          | (
              '%s:PairWithVoid' % self.label
              >> core.Map(lambda x: (x, None)).with_output_types(
                  paired_with_void_type)
)
