...
class CombineTest(unittest.TestCase):
  ...
  def test_combining_with_sliding_windows_and_fanout_raises_error_legacy(self):
    # Legacy behavior: SlidingWindows + fanout raises ValueError when
    # update_compatibility_version is prior to 2.73.0.
