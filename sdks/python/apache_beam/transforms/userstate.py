...
class BagStateSpec(StateSpec):
  """Specification for a user DoFn bag state cell.
     Read more about BagState here: https://beam.apache.org/documentation/programming-guide/#bagstate"""
  def to_runner_api(
      self, context: 'PipelineContext') -> beam_runner_api_pb2.StateSpec:
    return beam_runner_api_pb2.StateSpec(
...
class SetStateSpec(StateSpec):
  """Specification for a user DoFn Set State cell.
    Read more about SetState here: https://beam.apache.org/documentation/programming-guide/#setstate"""
  def to_runner_api(
      self, context: 'PipelineContext') -> beam_runner_api_pb2.StateSpec:
    return beam_runner_api_pb2.StateSpec(
...
class CombiningValueStateSpec(StateSpec):
  """Specification for a user DoFn combining value state cell.
     Read more about CombiningValueState here: https://beam.apache.org/documentation/programming-guide/#combiningstate"""
  def __init__(
      self,
      name: str,
...
class OrderedListStateSpec(StateSpec):
  """Specification for a user DoFn ordered list state cell.
     Read more about OrderedListState here: https://beam.apache.org/documentation/programming-guide/#orderliststate"""
  def to_runner_api(
      self, context: 'PipelineContext') -> beam_runner_api_pb2.StateSpec:
    return beam_runner_api_pb2.StateSpec(
...
class TimerSpec(object):
  """Specification for a user stateful DoFn timer.
     Read more about Timers here: https://beam.apache.org/documentation/programming-guide/#timers"""
  prefix = "ts-"
