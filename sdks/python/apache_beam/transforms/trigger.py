...
def create_trigger_driver(
  ...
  # TODO(https://github.com/apache/beam/issues/20165): Respect closing and on-time behaviors.
...
class InMemoryUnmergedState(UnmergedState):
  ...
  def get_earliest_hold(self):
    ...
    for unused_window, tagged_states in self.state.items():
      # TODO(https://github.com/apache/beam/issues/18441): currently, this assumes that the watermark hold tag
