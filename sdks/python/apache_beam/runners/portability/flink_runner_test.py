...
class FlinkRunnerTest(portable_runner_test.PortableRunnerTest):
  ...
  def test_callbacks_with_exception(self):
    raise unittest.SkipTest("Issue 19526")

  def test_register_finalizations(self):
    raise unittest.SkipTest("Issue 19526")

  def test_custom_merging_window(self):
    raise unittest.SkipTest("Issue 20641")

  # Inherits all other tests.


class FlinkRunnerTestOptimized(FlinkRunnerTest):
  # TODO: Remove these tests after resolving Issue 19422 and enabling
  ...
  def test_external_transform(self):
    raise unittest.SkipTest("Issue 19461")
