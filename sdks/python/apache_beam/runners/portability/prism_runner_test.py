...
class PrismRunnerTest(portable_runner_test.PortableRunnerTest):
  ...
  def test_custom_merging_window(self):
    raise unittest.SkipTest("Requires Prism to support Custom Window Coders, and Merging Custom Windows. TODO(file issue)")

  def test_custom_window_type(self):
    raise unittest.SkipTest("Requires Prism to support Custom Window Coders. TODO(file issue)")

  def test_pack_combiners(self):
    raise unittest.SkipTest("Requires Prism to support coder: 'beam:coder:tuple:v1'. TODO(file issue)")
