...
class ApiResponse(TypedDict):
    data: Optional[FlowGraph]
    error: Optional[str]

# ======================== Main Function ========================

def parse_beam_yaml(yaml_str: str, isDryRunMode: bool = False) -> ApiResponse:
    """
    ...
    try:
        ...
        if not parsed_yaml or 'pipeline' not in parsed_yaml:
            return build_error_response("Invalid YAML structure: missing 'pipeline' section")
...
def build_error_response(error_msg: str) -> ApiResponse:
