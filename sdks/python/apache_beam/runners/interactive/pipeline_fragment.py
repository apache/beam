...
class PipelineFragment(object):
  ...
  def __init__(self, pcolls, options=None):
    ...
    # This will give us the 1:1 correlation between PCollections from the copied
  ...
  def _calculate_user_transform_labels(self):
    ...
    for transform in ie.current_env().tracked_transforms:
      if transform is not None:
        label_to_user_transform[transform.full_label] = transform
