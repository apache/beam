...
class PipelineContext(object):
  ...
  def __init__(self,
    ...
    # TODO(https://github.com/apache/beam/issues/20827) Initialize component_id_map with objects from proto.
  ...
  # TODO(https://github.com/apache/beam/issues/18490): Remove once this is no longer needed.
