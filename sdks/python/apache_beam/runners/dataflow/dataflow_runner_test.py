...
# Due to Issue 19848, these need to be declared outside of the test method.
...
class DataflowRunnerTest(unittest.TestCase, ExtraAssertionsMixin):
  ...
  def test_remote_runner_display_data(self):
    ...
    # TODO(Issue 18012) Enable runner API on this test.
  ...
  @unittest.skip('Issue 18716: enable once CombineFnVisitor is fixed')
