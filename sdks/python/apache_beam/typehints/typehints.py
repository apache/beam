...
class SequenceTypeConstraint(IndexableTypeConstraint):
  ...
  def __eq__(self, other):
    return (
        isinstance(other, SequenceTypeConstraint)
  ...
  def _consistent_with_check_(self, sub):
    return isinstance(sub, self.__class__) and is_consistent_with(
        sub.inner_type, self.inner_type)
...
class UnionHint(CompositeTypeHint):
  ...
  class UnionConstraint(TypeConstraint):
    ...
    def __eq__(self, other):
      return (
          isinstance(other, UnionHint.UnionConstraint)
...
class TupleHint(CompositeTypeHint):
  ...
  class TupleConstraint(IndexableTypeConstraint):
    ...
    def __eq__(self, other):
      return (
          isinstance(other, TupleHint.TupleConstraint)
    ...
    def type_check(self, tuple_instance):
      ...
      for type_pos, (expected, actual) in enumerate(
          zip(self.tuple_types, tuple_instance)):
        try:
...
class IteratorHint(CompositeTypeHint):
  ...
  class IteratorTypeConstraint(TypeConstraint):
    ...
    def _consistent_with_check_(self, sub):
      return isinstance(sub, self.__class__) and is_consistent_with(
          sub.yielded_type, self.yielded_type)
...
class WindowedTypeConstraint(
  ...
  def __eq__(self, other):
    return (
        isinstance(other, WindowedTypeConstraint)
        and self.inner_type == other.inner_type)
