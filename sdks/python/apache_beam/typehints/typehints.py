...
# TODO(https://github.com/apache/beam/issues/20982): Remove this function and use plain repr() instead.
def _unified_repr(o):
...
class AnyTypeConstraint(TypeConstraint):
  ...
  def __hash__(self):
    # TODO(https://github.com/apache/beam/issues/18633): Fix typehints.TypeVariable issues with __hash__.
    return hash(id(self))
