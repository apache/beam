    ...
    test_cases = [
        ...
        (
            ...
            typing.Tuple[
                bytes,
                typing.List[
                    typing.Tuple[bytes, typing.Union[int, bytes, float]]
                ],
            ],
            typehints.Tuple[
                bytes,
                typehints.List[
                    typehints.Tuple[bytes, typehints.Union[int, bytes, float]]
                ],
            ],
        ),
        ...
        (
            ...
            typehints.Dict[
                bytes, typehints.List[typehints.Tuple[bytes, _TestClass]]
            ],
        ),
    ]
