...
def run_count1(pipeline_options=None):
...
def run_count2(pipeline_options=None):
...
def run_count3(pipeline_options=None):
...
def run(pipeline_options=None):
  run_count1(pipeline_options)
  run_count2(pipeline_options)
  run_count3(pipeline_options)
