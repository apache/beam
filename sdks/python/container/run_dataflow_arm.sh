...
TAG="$(grep 'unique_tag' job_PostCommit_Python_Dataflow_Arm.groovy | cut -d'=' -f2)"
...
echo ">>> RUNNING DATAFLOW RUNNER PYTHON ARM TEST"
...
echo ">>> SUCCESS DATAFLOW RUNNER PYTHON ARM TEST"
