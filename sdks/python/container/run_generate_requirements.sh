...
pip install ${PIP_EXTRA_OPTIONS:+"$PIP_EXTRA_OPTIONS"} -c "$PWD"/sdks/python/container/base_image_requirements_manual.txt --no-cache-dir "$SDK_TARBALL""$EXTRAS" $INDEX_URL_OPTION
