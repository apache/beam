...
export const JS_ASSIGN_TIMESTAMPS_DOFN_URN = "beam:dofn:js_assign_timestamps:v1";

let _coder_counter = 0;
const _CODER_ID_PREFIX = 'coder_';

export function registerPipelineCoder(coderProto: runnerApi.Coder, pipelineComponents: runnerApi.Components) {
