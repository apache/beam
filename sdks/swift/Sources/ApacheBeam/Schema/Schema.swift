...
public extension FieldsBuilder {
    ...
    func byte(_ name:String,description:String? = nil,nullable:Bool=false) -> FieldsBuilder {
        return field(name,type:nullable ? .nullable(.byte) : .byte,description:description,options:[:])
    }
    
    @discardableResult
    func int16(_ name:String,description:String? = nil,nullable:Bool=false) -> FieldsBuilder {
        return field(name,type:nullable ? .nullable(.int16) : .int16,description:description,options:[:])
    }
    
    @discardableResult
    func int32(_ name:String,description:String? = nil,nullable:Bool=false) -> FieldsBuilder {
        return field(name,type:nullable ? .nullable(.int32) : .int32,description:description,options:[:])
    }
    
    @discardableResult
    func int64(_ name:String,description:String? = nil,nullable:Bool=false) -> FieldsBuilder {
        return field(name,type:nullable ? .nullable(.int64) : .int64,description:description,options:[:])
    }
   
    @discardableResult
    func float(_ name:String,description:String? = nil,nullable:Bool=false) -> FieldsBuilder {
        return field(name,type:nullable ? .nullable(.float) : .float,description:description,options:[:])
    }
    
    @discardableResult
    func double(_ name:String,description:String? = nil,nullable:Bool=false) -> FieldsBuilder {
        return field(name,type:nullable ? .nullable(.double) : .double,description:description,options:[:])
    }
    
    @discardableResult
    func string(_ name:String,description:String? = nil,nullable:Bool=false) -> FieldsBuilder {
        return field(name,type:nullable ? .nullable(.string) : .string,description:description,options:[:])
    }
    
    @discardableResult
    func datetime(_ name:String,description:String? = nil,nullable:Bool=false) -> FieldsBuilder {
        return field(name,type:nullable ? .nullable(.datetime) : .datetime,description:description,options:[:])
    }
    
    @discardableResult
    func boolean(_ name:String,description:String? = nil,nullable:Bool=false) -> FieldsBuilder {
        return field(name,type:nullable ? .nullable(.boolean) : .boolean,description:description,options:[:])
    }
    
    @discardableResult
    func bytes(_ name:String,description:String? = nil,nullable:Bool=false) -> FieldsBuilder {
        return field(name,type:nullable ? .nullable(.bytes) : .bytes,description:description,options:[:])
    }
    
    @discardableResult
    func decimal(_ name:String,_ precision: Int,_ scale: Int,description:String? = nil,nullable:Bool=false) -> FieldsBuilder {
        return field(name,type:nullable ? .nullable(.decimal(precision,scale)) : .decimal(precision,scale),description:description,options:[:])
    }
    
    @discardableResult
    func row(_ name:String,description:String? = nil,_ fn: (inout FieldsBuilder) -> Void) -> FieldsBuilder {
        return field(name,type:.row(Schema() { fn(&$0) }),description:description,options:[:])
    }
}
