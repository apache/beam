...
/** An end-to-end test for {@link org.apache.beam.examples.cookbook.TriggerExample}. */
@RunWith(JUnit4.class)
public class TriggerExampleIT {
  private TriggerExampleIT.TriggerExamplesOptions options;
  ...
  /** Options for the TriggerExamples Integration Test. */
  public interface TriggerExamplesOptions
      extends TestPipelineOptions, TriggerExample.TrafficFlowOptions {}
  ...
  @Test
  public void testE2ETriggerExamples() throws Exception {
    this.options.setBigQueryDataset(outputDatasetId);
    this.options.setBigQueryTable(outputTable);
