 ...
 *
 * This tests uses as input text of King Lear, by William Shakespeare as plaintext files, and will
...
public class DistinctExampleIT {
  ...
  public void testE2EDistinctExample() throws Exception {
    DistinctExampleOptions options = TestPipeline.testingPipelineOptions().as(DistinctExampleOptions.class);
    options.setOutput(
