...
public class HourlyTeamScoreTest implements Serializable {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(HourlyTeamScoreTest.class);
  ...
  public void testUserScoresFilter() throws Exception {
    ...
    List<String> gameEvents = getRecordsFromCSVFile("hourly_team_score_game_events.csv");
    List<String> filteredEvents = getRecordsFromCSVFile("hourly_team_score_filtered_events.csv");
