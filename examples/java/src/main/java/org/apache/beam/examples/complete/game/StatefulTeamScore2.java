...
public class StatefulTeamScore2 extends LeaderBoard {
  ...
  public static class UpdateTeamScoreFn
     ...
     *
     * <p>A {@link ReadModifyWriteState} stores single value per key and per window. Because our pipeline is
     ...
     */
    @StateId(TOTAL_SCORE)
    private final StateSpec<ReadModifyWriteState<Integer>> totalScoreSpec =
    ...
    public void processElement(
        ProcessContext c, @StateId(TOTAL_SCORE) ReadModifyWriteState<Integer> totalScore) {
