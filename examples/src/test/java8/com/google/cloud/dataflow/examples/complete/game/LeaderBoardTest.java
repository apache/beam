...
public class LeaderBoardTest implements Serializable {
  ...
  public void testTeamScoresOnTime() {
    ...
    DataflowAssert.that(teamScores)
  ...
  public void testTeamScoresObservablyLate() {
    ...
    DataflowAssert.thatMap(teamScores)
    ...
    DataflowAssert.that(teamScores).inFinalPane(window).containsInAnyOrder(KV.of(redTeam, 27));
  ...
  public void testTeamScoresDroppablyLate() {
    ...
    DataflowAssert.that(teamScores).inFinalPane(window).empty();
  }
  ...
  public void testUserScore() {
    ...
    DataflowAssert.that(userScores)
