...
function download_files() {
  if [[ $1 = *"wheel"* ]]; then
    if [[ $2 == "python3.9" ]]; then
      BEAM_PYTHON_SDK_WHL="apache_beam-$VERSION*-cp39-cp39m-manylinux_2_17_x86_64.manylinux2014_x86_64.whl"
      ...
      BEAM_PYTHON_SDK_WHL="apache_beam-$VERSION*-cp311-cp311-manylinux_2_17_x86_64.manylinux2014_x86_64.whl"
    elif [[ $2 == "python3.12" ]]; then
      BEAM_PYTHON_SDK_WHL="apache_beam-$VERSION*-cp312-cp312-manylinux_2_17_x86_64.manylinux2014_x86_64.whl"
    else
