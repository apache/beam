...
#### Java PreCommit Beam Examples - [job-precommit-beam-examples.yml](.github/workflows/job-precommit-beam-examples.yml)

| Job                               | Description                        | Pull Request Run | Direct Push/Merge Run | Scheduled Run | Requires GCP Credentials |
|-----------------------------------|------------------------------------|------------------|-----------------------|---------------|--------------------------|
| Run Java PreCommit Beam Examples  | Runs Java PreCommit Beam Examples  | Yes              | Yes                   | Yes           | No                       |
