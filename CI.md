...
|--------------------------------------------------------------------------------|---------------------------|--------------------------|
| [job-precommit-rat.yml](.github/workflows/job-precommit-rat.yml)               | Runs RAT PreCommit        | No                       |
| [job-precommit-spotless.yml](.github/workflows/job-precommit-spotless.yml)     | Runs Spotless PreCommit   | No                       |
| [job-precommit-whitespace.yml](.github/workflows/job-precommit-whitespace.yml) | Runs Whitespace PreCommit | No                       |
