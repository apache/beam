...
|------------------------------------------------------------------------------------------|-----------------------|--------------------------|
| [job-precommit-pythondocs.yml](.github/workflows/job-precommit-pythondocs.yml)           | Runs Python Docs      | No                       |
| [job-precommit-pythonformatter.yml](.github/workflows/job-precommit-pythonformatter.yml) | Runs Python Formatter | No                       |
| [job-precommit-pythonlint.yml](.github/workflows/job-precommit-pythonlint.yml)           | Runs Python Lint      | No                       |
