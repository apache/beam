...
#### Python PreCommit Parquet IO - [job-precommit-python-parquet-io.yml](.github/workflows/job-precommit-python-parquet-io.yml)

| Job                               | Description                        | Pull Request Run | Direct Push/Merge Run | Scheduled Run | Requires GCP Credentials |
|-----------------------------------|------------------------------------|------------------|-----------------------|---------------|--------------------------|
| Run Python PreCommit Parquet IO   | Runs Python PreCommit Parquet IO   | Yes              | Yes                   | Yes           | No                       |
