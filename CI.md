...
#### Python PreCommit Dataframe - [job-precommit-python-dataframe.yml](.github/workflows/job-precommit-python-dataframe.yml)

| Job                             | Description                      | Pull Request Run | Direct Push/Merge Run | Scheduled Run | Requires GCP Credentials |
|---------------------------------|----------------------------------|------------------|-----------------------|---------------|--------------------------|
| Run Python PreCommit Dataframe  | Runs Python PreCommit Dataframe  | Yes              | Yes                   | Yes           | No                       |
