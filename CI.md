...
#### Java PreCommit Runners Direct - [job-precommit-runners-direct.yml](.github/workflows/job-precommit-runners-direct.yml)

| Job                               | Description                        | Pull Request Run | Direct Push/Merge Run | Scheduled Run | Requires GCP Credentials |
|-----------------------------------|------------------------------------|------------------|-----------------------|---------------|--------------------------|
| Run Java PreCommit Runners Direct | Runs Java PreCommit Runners Direct | Yes              | Yes                   | Yes           | No                       |
