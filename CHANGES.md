...
* Added native Python GenerateSequence transform for generating bounded and unbounded sequences of integers, with optional rate limiting support (Python) ([#18088](https://github.com/apache/beam/issues/18088)).
