...
* Added documentation and examples for Milvus enrichment transform (Python) ([#35467](https://github.com/apache/beam/pull/35467)).
  Comprehensive documentation and Jupyter notebook examples now available for vector, keyword, and hybrid search operations with Milvus.
