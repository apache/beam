...
* Ignore error `Command not supported` because of CosmosDB not support `splitVector` command in Java SDK ([BEAM-14004](https://issues.apache.org/jira/browse/BEAM-14004)).
