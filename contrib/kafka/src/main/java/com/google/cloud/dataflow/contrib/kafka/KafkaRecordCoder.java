...
public class KafkaRecordCoder<K, V> extends StandardCoder<KafkaRecord<K, V>> {
  ...
  @JsonCreator
  public static KafkaRecordCoder<?, ?> of(
  ...
  @Override
  public void encode(
      com.google.cloud.dataflow.contrib.kafka.KafkaRecord<K, V> value,
  ...
  @Override
  public com.google.cloud.dataflow.contrib.kafka.KafkaRecord<K, V> decode(
      InputStream inStream, Context context) throws CoderException, IOException {
    Context nested = context.nested();
    return new com.google.cloud.dataflow.contrib.kafka.KafkaRecord<K, V>(
  ...
  public boolean isRegisterByteSizeObserverCheap(
      com.google.cloud.dataflow.contrib.kafka.KafkaRecord<K, V> value, Context context) {
  ...
  @Override
  public Object structuralValue(com.google.cloud.dataflow.contrib.kafka.KafkaRecord<K, V> value)
      throws Exception {
    if (consistentWithEquals()) {
      return value;
    } else {
      return new com.google.cloud.dataflow.contrib.kafka.KafkaRecord<Object, Object>(
          value.getTopic(),
          value.getPartition(),
          value.getOffset(),
