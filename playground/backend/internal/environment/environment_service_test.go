...
func Test_getApplicationEnvsFromOsEnvs(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want:      NewApplicationEnvs("/app", defaultLaunchSite, defaultProjectId, defaultPipelinesFolder, &CacheEnvs{defaultCacheType, defaultCacheAddress, convertedTime}, defaultPipelineExecuteTimeout),
			wantErr:   false,
		...
		{
			name:      "CacheKeyExpirationTimeKey is set with the correct value",
			want:      NewApplicationEnvs("/app", defaultLaunchSite, defaultProjectId, defaultPipelinesFolder, &CacheEnvs{defaultCacheType, defaultCacheAddress, defaultCacheKeyExpirationTime}, convertedTime),
			wantErr:   false,
