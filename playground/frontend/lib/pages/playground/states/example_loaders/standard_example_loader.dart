...
/// If [ExampleState] has a catalog, waits for it to load,
/// then gets the example from there, and loads additional info from network.
///
/// If [ExampleState] has no catalog, loads the entire example from network.
