...
2. [GCP User account]([https://cloud.google.com/iam/docs/creating-managing-service-accounts](https://cloud.google.com/appengine/docs/standard/access-control?tab=python)) _(Note: You will find the instruction "How to create User account" for your new project)_
