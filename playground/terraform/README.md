...
```
[How](https://cloud.google.com/resource-manager/docs/creating-managing-projects) _(Note:How to create a new project in Google Cloud Platform. It's strongly recommended to use the new Google Cloud Project for your new projects)_
```
