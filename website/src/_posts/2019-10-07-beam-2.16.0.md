 ...
 * Integration improvements for Python Streaming on Dataflow including service features like autoscaling, drain, update and counter updates.
...
* Portable Flink pipelines can now be bundled into executable jars. ([BEAM-7967](https://issues.apache.org/jira/browse/BEAM-7967), [BEAM-7966](https://issues.apache.org/jira/browse/BEAM-7966))
...
* Performance regression in DirectRunner in streaming mode. ([BEAM-8363](https://issues.apache.org/jira/browse/BEAM-8363))
