...
The following graphs show various metrics when running PyTorch Image Captioning BLIP + CLIP Streaming CPU pipeline.
...
{{< performance_looks io="pytorchimagecaptioningstreamingcpu" read_or_write="write" section="cost" >}}

## How has various metrics changed when running the pipeline for different Beam SDK versions?

{{< performance_looks io="pytorchimagecaptioningstreamingcpu" read_or_write="write" section="version" >}}

## How has various metrics changed over time when running the pipeline?

{{< performance_looks io="pytorchimagecaptioningstreamingcpu" read_or_write="write" section="date" >}}
