---
title: "MLTransform Image Embedding GPU Performance"
---
...
{{< performance_looks io="mltransform-image-embedding-gpu" read_or_write="write" section="cost" >}}

## How has various metrics changed when running the pipeline for different Beam SDK versions?

{{< performance_looks io="mltransform-image-embedding-gpu" read_or_write="write" section="version" >}}

## How has various metrics changed over time when running the pipeline?

{{< performance_looks io="mltransform-image-embedding-gpu" read_or_write="write" section="date" >}}

See also [MLTransform Image Embedding CPU](/performance/mltransform-image-embedding-cpu)
for the CPU right-fitting variant of this pipeline.
