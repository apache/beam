---
title: "PyTorch Image Classification EfficientNet-B0 Streaming (Right-fitting) GPU Performance"
---
...
{{< performance_looks io="pytorchimagenetrightfitgpu" read_or_write="write" section="cost" >}}

## How has various metrics changed when running the pipeline for different Beam SDK versions?

{{< performance_looks io="pytorchimagenetrightfitgpu" read_or_write="write" section="version" >}}

## How has various metrics changed over time when running the pipeline?

{{< performance_looks io="pytorchimagenetrightfitgpu" read_or_write="write" section="date" >}}
