...
### 2.44.0 (2023-01-12)
Official [source code download](https://downloads.apache.org/beam/2.44.0/apache-beam-2.44.0-source-release.zip).
[SHA-512](https://downloads.apache.org/beam/2.43.0/apache-beam-2.44.0-source-release.zip.sha512).
[signature](https://downloads.apache.org/beam/2.43.0/apache-beam-2.44.0-source-release.zip.asc).
