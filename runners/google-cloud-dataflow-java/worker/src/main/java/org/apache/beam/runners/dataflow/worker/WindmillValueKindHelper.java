...
/**
 * Utility class for converting between {@link ValueKind} and {@link Elements.ValueKind.Enum} inside
 * the Dataflow Worker. This is a duplicate of the utility inside core sdk because core utility is
 * compiled against unrepackaged BeamFnApi, whereas Dataflow Worker relocates BeamFnApi to dataflow
 * repackaged version causing NoSuchMethodErrors at runtime.
 */
final class WindmillValueKindHelper {
