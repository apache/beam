...
public abstract class StreamingEnginePipelineConfig {
  ...
  public static StreamingEnginePipelineConfig.Builder builder() {
    return new AutoValue_StreamingEnginePipelineConfig.Builder()
        ...
        .setComputationConfigs(ImmutableList.of())
  ...
  public abstract ImmutableList<StreamingComputationConfig> computationConfigs();
  ...
  public abstract static class Builder {
    ...
    public abstract Builder setComputationConfigs(ImmutableList<StreamingComputationConfig> value);
