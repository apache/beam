...
@Internal
@ThreadSafe
public class StreamingEnginePipelineConfigManager {
  ...
  public StreamingEnginePipelineConfigManager(boolean initializeWithDefaults) {
    if (initializeWithDefaults) {
      streamingEngineConfig.set(StreamingEnginePipelineConfig.builder().build());
    }
  }
