...
public class BatchModeExecutionContext
  ...
  // TODO(https://github.com/apache/beam/issues/19632): Move throttle time Metric to a dedicated namespace.
  ...
  public Long extractThrottleTime() {
    ...
    for (MetricsContainerImpl container : containerRegistry.getContainers()) {
      // TODO(https://github.com/apache/beam/issues/19632): Update throttling counters to use generic throttling-msecs metric.
