...
public class StreamingStepMetricsContainer implements MetricsContainer {
  ...
  /**
   * Returns {@link PerStepNamespaceMetrics} representing the changes to all PerWorkerMetrics that
   * have changed since the last time this function was invoked.
   */
  ...
  // Methods to test that zero-valued perWorkerMetrics metrics are properly deleted.
  @VisibleForTesting
