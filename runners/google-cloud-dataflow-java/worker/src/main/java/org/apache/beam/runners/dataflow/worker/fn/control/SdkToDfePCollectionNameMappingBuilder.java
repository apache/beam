...
/**
 * Helper class that can build SDK to DFE PCollection name mapping.
 *
 * <p>Receives system to dfe name mapping and ProcessBundleDescriptors to rely
 */
public class SdkToDfePCollectionNameMappingBuilder {
