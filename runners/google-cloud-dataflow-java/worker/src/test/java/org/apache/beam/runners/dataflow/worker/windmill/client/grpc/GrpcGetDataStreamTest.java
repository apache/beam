...
public class GrpcGetDataStreamTest {
  ...
  @Test
  public void testRequestKeyedData_sendOnClosedStreamThrowsWindmillStreamClosedException() {
    ...
    for (int i = 0; i < numSendThreads; i++) {
      ...
      if (i % 2 == 0) {
        ...
        assertThat(e).hasCauseThat().isInstanceOf(WindmillStreamClosedException.class);
      }
    }
  }
