...
public class ListOutputManager implements WindowedValueMultiReceiver {
  ...
  @Override
  public <OutputT> WindowedValueReceiver<OutputT> forTag(TupleTag<OutputT> tag) {
    final List<WindowedValue<OutputT>> outputList = getOutput(tag);
    return output -> outputList.add((WindowedValue<OutputT>) output);
  }
}
