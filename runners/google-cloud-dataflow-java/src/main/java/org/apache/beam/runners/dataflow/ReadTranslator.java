...
class ReadTranslator implements TransformTranslator<Read.PrimitiveBoundedRead<?>> {
  @Override
  public void translate(Read.PrimitiveBoundedRead<?> transform, TranslationContext context) {
