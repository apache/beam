 ...
 *
 * <p>An elastic-sized byte array which allows you to manipulate it as a stream, or access it
 * directly. This allows for a quick succession of moving bytes from an {@link InputStream} to this
 * wrapper to be used as an {@link OutputStream} and vice versa. This wrapper also provides random
 * access to bytes stored within. This wrapper allows users to finely control the number of byte
 * copies that occur.
 *
