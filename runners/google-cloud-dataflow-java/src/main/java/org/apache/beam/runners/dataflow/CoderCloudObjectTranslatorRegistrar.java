 ...
 *
 * <p>{@link Coder} authors have the ability to automatically have their {@link Coder} registered
 * with the Dataflow Runner by creating a {@link ServiceLoader} entry and a concrete implementation
 * of this interface.
 *
 * <p>It is optional but recommended to use one of the many build time tools such as {@link
 * com.google.auto.service.AutoService AutoService} to generate the necessary META-INF files
 * automatically.
 */
@Internal
