...
/** Mutable state shared while translating a portable pipeline into a Kafka Streams topology. */
public class KafkaStreamsTranslationContext {
  ...
  public static KafkaStreamsTranslationContext create(
    ...
    return new KafkaStreamsTranslationContext(jobInfo, pipelineOptions);
  }
