...
public class InMemoryTimerInternals implements TimerInternals {
  ...
  public void setTimer(TimerData timerData) {
    WindowTracing.trace("{}.setTimer: {}", simpleName, timerData);
  ...
  public void advanceProcessingTime(Instant newProcessingTime) throws Exception {
    ...
    checkState(
        ...
        newProcessingTime);
    WindowTracing.trace(
        "{}.advanceProcessingTime: from {} to {}", simpleName, processingTime, newProcessingTime);
  ...
  public @Nullable TimerData removeNextEventTimer() {
    ...
    if (timer != null) {
      WindowTracing.trace(
          "{}.removeNextEventTimer: firing {} at {}", simpleName, timer, inputWatermarkTime);
    }
    return timer;
  }
  ...
  public @Nullable TimerData removeNextProcessingTimer() {
    ...
    if (timer != null) {
      WindowTracing.trace(
          "{}.removeNextProcessingTimer: firing {} at {}", simpleName, timer, processingTime);
    }
    return timer;
  }
