...
/**
 * {@link TriggerReactor}s that fire based on properties of the elements in the current pane.
 */
@Experimental(Experimental.Kind.TRIGGER)
public class AfterPaneReactor extends OnceTriggerReactor {
...
private static final StateTag<Object, AccumulatorCombiningState<Long, long[], Long>>
  ...
  private AfterPaneReactor(int countElems) {
    super(null);
   ...
   */
  public static AfterPaneReactor elementCountAtLeast(int countElems) {
    return new AfterPaneReactor(countElems);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof AfterPaneReactor)) {
      return false;
    }
    AfterPaneReactor that = (AfterPaneReactor) obj;
