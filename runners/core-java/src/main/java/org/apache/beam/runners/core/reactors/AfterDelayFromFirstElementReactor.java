...
public abstract class AfterDelayFromFirstElementReactor extends OnceTriggerReactor {
   ...
   */
  @Nullable
  public abstract Instant getCurrentTime(TriggerReactor.TriggerContext context);
   ...
   */
  protected abstract AfterDelayFromFirstElementReactor newWith(
  ...
  public AfterDelayFromFirstElementReactor(
   ...
   * CalendarWindows.
   */
  public AfterDelayFromFirstElementReactor alignedTo(final Duration size, final Instant offset) {
   ...
   * since the epoch.
   */
  public AfterDelayFromFirstElementReactor alignedTo(final Duration size) {
   ...
   */
  public AfterDelayFromFirstElementReactor plusDelayOf(final Duration delay) {
  ...
  public boolean isCompatible(TriggerReactor other) {
    ...
    AfterDelayFromFirstElementReactor that = (AfterDelayFromFirstElementReactor) other;
    return this.timestampMappers.equals(that.timestampMappers);
  }


  private AfterDelayFromFirstElementReactor newWith(
