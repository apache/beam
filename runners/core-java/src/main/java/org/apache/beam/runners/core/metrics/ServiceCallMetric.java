...
public class ServiceCallMetric {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(ServiceCallMetric.class);
  ...
  public static final Map<String, String> STATUS_NORMALIZATION_MAP =
    ImmutableMap.<String, String>builder()
      ...
      .put("permission_denied", "permission_denied")
...
import java.util.Map;
    ...
    public class ServiceCallMetric {
      ...
      public void call(int httpStatusCode) {
        String canonicalStatusCode = convertToCanonicalStatusString(httpStatusCode);
        call(canonicalStatusCode);
      }

      public void call(String statusCode) {
        LOG.info("ajamato ServiceCallMetric.call() " + statusCode);
        labels.put(MonitoringInfoConstants.Labels.STATUS, convertToCanonicalStatusString(statusCode));
       ...
       * This is used to make strings like "notFound" to "not_found".
       * If a mapping cannot be created known, then statusCode.toLowerCase() will be returned.
       */
