 ...
 */
public class RepeatedlyReactor extends TriggerReactor {
   ...
   *
   * <p>Unless used with {@link TriggerReactor#orFinally} the composite trigger will never finish.
   *
   * @param repeated the trigger to execute repeatedly.
   */
  public static RepeatedlyReactor forever(TriggerReactor repeated) {
    return new RepeatedlyReactor(repeated);
  }

  private RepeatedlyReactor(TriggerReactor repeated) {
  ...
  private ExecutableTriggerReactor getRepeated(TriggerContext context) {
