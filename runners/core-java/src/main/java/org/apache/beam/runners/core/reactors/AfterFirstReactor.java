...
/**
 * Create a composite {@link TriggerReactor} that fires once after at least one of its sub-triggers
 * have fired.
 */
@Experimental(Experimental.Kind.TRIGGER)
public class AfterFirstReactor extends OnceTriggerReactor {

  AfterFirstReactor(List<TriggerReactor> subTriggers) {
    super(subTriggers);
   ...
   */
  @SafeVarargs
  public static OnceTriggerReactor of(
      OnceTriggerReactor... triggers) {
    return new AfterFirstReactor(Arrays.<TriggerReactor>asList(triggers));
  }
