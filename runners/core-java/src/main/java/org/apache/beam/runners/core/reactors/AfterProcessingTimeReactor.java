...
public class AfterProcessingTimeReactor extends AfterDelayFromFirstElementReactor {
  ...
  private AfterProcessingTimeReactor(List<SerializableFunction<Instant, Instant>> transforms) {
   ...
   */
  public static AfterProcessingTimeReactor pastFirstElementInPane() {
    return new AfterProcessingTimeReactor(IDENTITY);
  }

  @Override
  protected AfterProcessingTimeReactor newWith(
      List<SerializableFunction<Instant, Instant>> transforms) {
    return new AfterProcessingTimeReactor(transforms);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof AfterProcessingTimeReactor)) {
      return false;
    }
    AfterProcessingTimeReactor that = (AfterProcessingTimeReactor) obj;
