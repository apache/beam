...
/**
 * Tests the {@link AfterSynchronizedProcessingTimeReactor}.
 */
@RunWith(JUnit4.class)
public class AfterSynchronizedProcessingTimeReactorTest {

  private TriggerReactor underTest = new AfterSynchronizedProcessingTimeReactor();

  @Test
  public void testAfterProcessingTimeWithFixedWindows() throws Exception {
    Duration windowDuration = Duration.millis(10);
    SimpleTriggerReactorTester<IntervalWindow> tester = TriggerReactorTester.forTrigger(
        AfterProcessingTimeReactor
