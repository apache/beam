...
/**
 * Tests for {@link NeverReactor}.
 */
@RunWith(JUnit4.class)
public class NeverReactorTest {
  private SimpleTriggerReactorTester<IntervalWindow> triggerTester;

  @Before
  public void setup() throws Exception {
    triggerTester =
        TriggerReactorTester.forTrigger(
            NeverReactor.ever(), FixedWindows.of(Duration.standardMinutes(5)));
  }
