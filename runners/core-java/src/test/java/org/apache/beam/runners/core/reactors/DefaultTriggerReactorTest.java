...
/**
 * Tests the {@link DefaultTriggerReactor}, which should be equivalent to
 * {@code Repeatedly.forever(AfterWatermark.pastEndOfWindow())}.
 */
@RunWith(JUnit4.class)
public class DefaultTriggerReactorTest {

  SimpleTriggerReactorTester<IntervalWindow> tester;

  @Test
  public void testDefaultTriggerFixedWindows() throws Exception {
    tester = TriggerReactorTester.forTrigger(
        DefaultTriggerReactor.of(),
