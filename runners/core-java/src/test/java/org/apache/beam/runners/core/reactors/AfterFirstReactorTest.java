...
/**
 * Tests for {@link AfterFirstReactor}.
 */
@RunWith(JUnit4.class)
public class AfterFirstReactorTest {

  @Mock private OnceTriggerReactor mockTrigger1;
  @Mock private OnceTriggerReactor mockTrigger2;
  ...
  public void testNeitherShouldFireFixedWindows() throws Exception {
    tester = TriggerReactorTester.forTrigger(
        AfterFirstReactor.of(mockTrigger1, mockTrigger2), FixedWindows.of(Duration.millis(10)));
  ...
  public void testShouldFireAfterMerge() throws Exception {
    tester = TriggerReactorTester.forTrigger(
        AfterEachReactor.inOrder(
            AfterFirstReactor.of(AfterPaneReactor.elementCountAtLeast(5),
