...
/**
 * Tests for {@link AfterAllReactor}.
 */
@RunWith(JUnit4.class)
public class AfterAllReactorTest {
  ...
  public void testT1FiresFirst() throws Exception {
    tester = TriggerReactorTester.forTrigger(
        AfterAllReactor.of(
            AfterPaneReactor.elementCountAtLeast(1),
  ...
  public void testToString() {
    TriggerReactor trigger =
        AfterAllReactor.of(StubTriggerReactor.named("t1"), StubTriggerReactor.named("t2"));
