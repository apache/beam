...
public class InMemoryTimerInternalsTest {
  ...
  public void testResetById() throws Exception {
    ...
    underTest.setTimer(NS1, ID1, ID1, earlyTimestamp, TimeDomain.EVENT_TIME);
    underTest.setTimer(NS1, ID1, ID1, laterTimestamp, TimeDomain.EVENT_TIME);
  ...
  public void testDeletionIdempotent() throws Exception {
    ...
    underTest.setTimer(NS1, ID1, ID1, timestamp, TimeDomain.EVENT_TIME);
