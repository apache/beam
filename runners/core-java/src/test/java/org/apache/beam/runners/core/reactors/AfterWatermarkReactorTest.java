...
/**
 * Tests the {@link AfterWatermarkReactor} triggers.
 */
@RunWith(JUnit4.class)
public class AfterWatermarkReactorTest {

  @Mock private OnceTriggerReactor mockEarly;
  @Mock private OnceTriggerReactor mockLate;
  ...
  public void testRunningAsTrigger(OnceTriggerReactor mockTrigger, IntervalWindow window)
      throws Exception {
  ...
  public void testEarlyAndLateOnMergeAlreadyFinished() throws Exception {
    tester = TriggerReactorTester.forTrigger(
        AfterWatermarkReactor.pastEndOfWindow()
            .withEarlyFirings(AfterPaneReactor.elementCountAtLeast(100))
            .withLateFirings(AfterPaneReactor.elementCountAtLeast(1)),
        Sessions.withGapDuration(Duration.millis(10)));
  ...
  public void testEarlyFiringsToString() {
    TriggerReactor trigger = AfterWatermarkReactor.pastEndOfWindow()
        .withEarlyFirings(StubTriggerReactor.named("t1"));
  ...
  public void testLateFiringsToString() {
    TriggerReactor trigger = AfterWatermarkReactor.pastEndOfWindow()
        .withLateFirings(StubTriggerReactor.named("t1"));
  ...
  public void testEarlyAndLateFiringsToString() {
    TriggerReactor trigger = AfterWatermarkReactor.pastEndOfWindow()
        .withEarlyFirings(StubTriggerReactor.named("t1"))
        .withLateFirings(StubTriggerReactor.named("t2"));
  ...
  public void testToStringExcludesNeverTrigger() {
    TriggerReactor trigger = AfterWatermarkReactor.pastEndOfWindow()
        .withEarlyFirings(NeverReactor.ever())
        .withLateFirings(NeverReactor.ever());
