...
/**
 *Test for Checkpoint configurations.
 */
@RunWith(JUnit4.class)
public class FlinkCheckPiontConfigTest {

  @Test
  public void testExtCheckPointConfigs() {
    String[] args = new String[] { "--externalizedCheckpointsEnabled=true",
        "--retainOnCancellation=false" };
    ...
    assertEquals(options.getRetainOnCancellation(), false);
  }
