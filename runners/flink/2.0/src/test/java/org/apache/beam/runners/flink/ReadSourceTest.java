...
public class ReadSourceTest extends JavaProgramTestBase {
  ...
  protected JobExecutionResult testProgram() throws Exception {
    return runProgram(resultPath);
  }

  private static JobExecutionResult runProgram(String resultPath) throws Exception {
    ...
    return new JobExecutionResult(
        new JobID(p.getOptions().getJobName().getBytes(StandardCharsets.UTF_8)),
