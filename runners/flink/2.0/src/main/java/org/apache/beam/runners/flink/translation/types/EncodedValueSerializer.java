  ...
  public TypeSerializerSnapshot<byte[]> snapshotConfiguration() {
    return new TypeSerializerSnapshot<byte[]>() {
      ...
      public TypeSerializerSchemaCompatibility<byte[]> resolveSchemaCompatibility(
          TypeSerializerSnapshot<byte[]> oldSerializerSnapshot) {
        // For maintainer: handle future incompatible change here
        if (oldSerializerSnapshot.restoreSerializer() instanceof EncodedValueSerializer) {
