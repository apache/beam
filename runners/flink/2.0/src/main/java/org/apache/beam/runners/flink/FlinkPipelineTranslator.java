...
/**
 * The role of this class is to translate the Beam operators to their Flink counterparts---a {@link
 * FlinkStreamingPipelineTranslator}. The {@link org.apache.beam.sdk.values.PCollection}-based
 * user-provided job is translated into a {@link
 * org.apache.flink.streaming.api.datastream.DataStream} (for batch) one.
 */
