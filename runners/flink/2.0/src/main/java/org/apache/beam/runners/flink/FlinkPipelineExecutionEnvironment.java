 ...
 * a Streaming or Batch processing one, it creates a {@link StreamExecutionEnvironment}), the
 * necessary {@link FlinkPipelineTranslator} or {@link FlinkStreamingPipelineTranslator}) to
...
class FlinkPipelineExecutionEnvironment {
  ...
  /**
   * The Flink DataStream execution environment. This is instantiated to either a {@link
   ...
   * org.apache.beam.sdk.values.PCollection} program into a
  ...
  public PipelineResult executePipeline() throws Exception {
    ...
    Preconditions.checkNotNull(flinkStreamEnv, "The Pipeline has not yet been translated.");
