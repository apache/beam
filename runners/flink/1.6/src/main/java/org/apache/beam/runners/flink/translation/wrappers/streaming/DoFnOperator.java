...
public class DoFnOperator<InputT, OutputT> extends AbstractStreamOperator<WindowedValue<OutputT>>
  ...
  interface OutputManagerFactory<OutputT> extends Serializable {
    FlinkOutputManager<OutputT> create(Output<StreamRecord<WindowedValue<OutputT>>> output);
  }
  ...
  public static class MultiOutputOutputManagerFactory<OutputT>
    ...
    @Override
    public FlinkOutputManager<OutputT> create(Output<StreamRecord<WindowedValue<OutputT>>> output) {
      return new FlinkOutputManager<>(output, mainTag, tagsToOutputTags, tagsToCoders, tagsToIds);
    }
  }
