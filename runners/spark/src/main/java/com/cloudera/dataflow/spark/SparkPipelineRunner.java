...
public class SparkPipelineRunner extends PipelineRunner<EvaluationResult> {
    ...
    private static final Map<Class<? extends PTransform>, TransformEvaluator> mEvaluators =
            Maps.newHashMap();
    ...
    private static TransformEvaluator<GroupByKey.GroupByKeyOnly> GBK = new TransformEvaluator<GroupByKey.GroupByKeyOnly>() {
        ...
        public void evaluate(GroupByKey.GroupByKeyOnly transform, EvaluationContext context) {
            context.setOutputRDD(transform, fromPair(toPair(context.getInputRDD(transform))
                    .groupByKey()));
        }
    };
        ...
        if (views == null) {
            ...
            for (PCollectionView<?, ?> view : views) {
                sideInputs.put(view.getTagInternal(),
                        context.getBroadcastHelper(view.getPObjectInternal()));
            }
            return sideInputs;
        }
    }
    ...
    public static <PT extends PTransform> void registerEvaluator(
        ...
        mEvaluators.put(transformClass, evaluator);
    }
    ...
    private static class Evaluator implements Pipeline.PipelineVisitor {
        ...
        public void visitTransform(TransformTreeNode node) {
            ...
            TransformEvaluator evaluator = mEvaluators.get(transform.getClass());
            if (evaluator == null) {
