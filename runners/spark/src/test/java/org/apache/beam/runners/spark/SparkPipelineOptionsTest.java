...
public class SparkPipelineOptionsTest {
  ...
  public void testCheckpointDirDefaultValue() {
    ...
    assertEquals(
        "SparkPipelineOptions.checkPointDir",
        "/tmp/" + sparkPipelineOptions.getJobName(),
        sparkPipelineOptions.getCheckpointDir());
    SparkCommonPipelineOptions sparkCommonPipelineOptions =
        PipelineOptionsFactory.create().as(SparkCommonPipelineOptions.class);
    assertEquals(
        "SparkCommonPipelineOptions.checkPointDir",
