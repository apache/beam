...
public class ReadTranslationTest {
  ...
  public void testToFromProtoBounded() throws Exception {
    ...
    Read.PrimitiveBoundedRead<?> boundedRead =
        new Read.PrimitiveBoundedRead<>(Read.from(boundedSource));
  ...
  public void testToFromProtoUnbounded() throws Exception {
    ...
    Read.PrimitiveUnboundedRead<?> unboundedRead =
        new Read.PrimitiveUnboundedRead<>(Read.from(unboundedSource));
    SdkComponents components = SdkComponents.create();
