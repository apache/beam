 ...
 * As per Beams's Portability Framework design, Cross-language transforms should work out of the box. In spite of this,
 * there always exists a possibility of rough edges existing. It could be caused due to unpolished implementation of any
 * part of the execution code path, for example:
 * <ul>
 *     <li>Transform expansion [SDK]</li>
 *     <li>Pipeline construction [SDK]</li>
 *     <li>Cross-language artifact staging [Runner]</li>
 *     <li>Language specific serialization/deserialization of PCollection (and other data types) [Runner/SDK]</li>
 * </ul>
...
public class ValidateRunnerXlangTest implements Serializable {
    ...
    /**
     * <ul>
     *     <li> <b>Target transform</b> – {@link ParDo} </li>
     *     <li> <b>Test scenario</b> – Mapping elements from a single input collection to a single output collection </li>
     *     <li>
     *         <b>Boundary conditions checked</b> –
     *         <ul>
     *            <li> PCollection<?> to external transforms </li>
     *              <li> PCollection<?> from external transforms </li>
     *         </ul>
     *     </li>
     * </ul>
     */
   ...
   *     <li>
   *         <b>Test scenario</b> – 
   *         Mapping elements from multiple input collections (main and side) to multiple output collections (main 
   *         and side)
   *     </li>
   *     <li>
   *         <b>Boundary conditions checked</b> –
   *         <ul>
   *            <li> PCollectionTuple to external transforms </li>
   *              <li> PCollectionTuple from external transforms </li>
   *         </ul>
   *     </li>
   * </ul>
   */
  ...
  /**
   * <ul>
   *     <li> <b>Target transform</b> – {@link GroupByKey} </li>
   *     <li> 
   *         <b>Test scenario</b> – Grouping a collection of KV&lt;K,V&gt; to a collection of KV&lt;K, Iterable&lt;
   *     V&gt;&gt; by key 
   *     </li>
   *     <li>
   *         <b>Boundary conditions checked</b> –
   *         <ul>
   *            <li> PCollection&lt;KV&lt;?, ?&gt;&gt; to external transforms </li>
   *              <li> PCollection&lt;KV&lt;?, Iterable&lt;?&gt;&gt;&gt; from external transforms </li>
   *         </ul>
   *     </li>
   * </ul>
   */
  ...
  /**
   * <ul>
   *     <li> <b>Target transform</b> – {@link CoGroupByKey} </li>
   *     <li> 
   *         <b>Test scenario</b> – Grouping multiple input collections with keys to a collection of KV&lt;K, CoGbkResult&gt; by key
   *     </li>
   *     <li>
   *         <b>Boundary conditions checked</b> –
   *         <ul>
   *            <li> KeyedPCollectionTuple<?> to external transforms </li>
   *              <li> PCollection&lt;KV&lt;?, Iterable&lt;?&gt;&gt;&gt; from external transforms </li>
   *         </ul>
   *     </li>
   * </ul>
  ...
  /**
   * <ul>
   *     <li> <b>Target transform</b> – {@link Combine} </li>
   *     <li> <b>Test scenario</b> – Combining elements globally with a predefined simple CombineFn </li>
   *     <li>
   *         <b>Boundary conditions checked</b> –
   *         <ul>
   *            <li> PCollection<?> to external transforms </li>
   ...
   * <ul>
   *     <li> <b>Target transform</b> – {@link Combine} </li>
   *     <li> <b>Test scenario</b> – Combining elements per key with a predefined simple merging function </li>
   *     <li>
   *         <b>Boundary conditions checked</b> –
   *         <ul>
   *            <li> PCollection<?> to external transforms </li>
  ...
  /**
   * <ul>
   *     <li> <b>Target transform</b> – {@link Flatten} </li>
   *     <li> <b>Test scenario</b> – Merging multiple collections into a single collection </li>
   *     <li>
   *         <b>Boundary conditions checked</b> –
   *         <ul>
   *            <li> PCollectionList<?> to external transforms </li>
   *              <li> PCollection<?> from external transforms </li>
   *         </ul>
   *     </li>
   * </ul>
  ...
  /**
   * <ul>
   *     <li> <b>Target transform</b> – {@link Partition} </li>
   *     <li> <b>Test scenario</b> – Splitting a single collection into multiple collections with a predefined simple PartitionFn </li>
   *     <li>
   *         <b>Boundary conditions checked</b> –
   *         <ul>
   *            <li> PCollection<?> to external transforms </li>
   *              <li> PCollectionList<?> from external transforms </li>
   *         </ul>
   *     </li>
   * </ul>
   */
