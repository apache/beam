...
/**
 * Represents a {@coder Coder} that is available in an external SDK that cannot be fully
 * interpretted in the Java SDK.
 */
public class KnownExternalCoder extends AtomicCoder<Object> {
  private String urn;
  private byte[] payload;

  private KnownExternalCoder(String urn, byte[] payload) {
    this.urn = urn;
    this.payload = payload;
  }

  public static KnownExternalCoder of(String urn, byte[] payload) {
    return new KnownExternalCoder(urn, payload);
  }

  @Override
  public void encode(Object value, OutputStream outStream) throws CoderException, IOException {
    throw new CoderException(
        "`KnownExternalCoder` was used to perform an actual encoding in the Java SDK. "
  ...
  public Object decode(InputStream inStream) throws CoderException, IOException {
    throw new CoderException(
        "`KnownExternalCoder` was used to perform an actual decoding in the Java SDK. "
