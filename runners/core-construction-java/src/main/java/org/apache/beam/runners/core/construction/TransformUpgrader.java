...
public class TransformUpgrader implements AutoCloseable {
  ...
  /**
   * A utility method that converts and arbitrary serializable object into a byte array.
   *
   * @param object an instance of type {@code Serializable}
   * @return {@code object} converted into bytes.
   */
  ...
  /**
   * A utility method that converts bytes obtained by invoking {@link #toByteArray(Object)} back to
   * a Java object.
   *
   * @param {@code bytes} generated by invoking the {@link #toByteArray(Object)} method.
