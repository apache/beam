...
public class Task {
    ...
    public static void main(String[] args) {
        ...
        PCollectionList<Analysis> pCollectionList = applyTransform(result);
    ...
    static PCollectionList<Analysis> applyTransform(PCollection<Analysis> input) {
        return input
