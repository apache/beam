...
variable "workflow_resource_name_base" {
  type        = string
  description = "The basis to derive of GCP Workflow related resource names such as Pub/Sub and the Workflow itself"
}

variable "eventarc_workflow_service_account_id" {
  type        = string
  description = "The Eventarc Workflow Service Account ID"
}
