...
class EchoServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Echo = channel.unary_unary(
            ...
            request_serializer=proto_dot_echo_dot_v1_dot_echo__pb2.EchoRequest.
            SerializeToString,
            response_deserializer=proto_dot_echo_dot_v1_dot_echo__pb2.
            EchoResponse.FromString,
        )
...
def add_EchoServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        grpc.unary_unary_rpc_method_handler(
            servicer.Echo,
            request_deserializer=proto_dot_echo_dot_v1_dot_echo__pb2.
            EchoRequest.FromString,
            response_serializer=proto_dot_echo_dot_v1_dot_echo__pb2.
            EchoResponse.SerializeToString,
        ),
    }
...
class EchoService(object):
    ...
    def Echo(request,
        ...
        return grpc.experimental.unary_unary(
            request, target, '/proto.echo.v1.EchoService/Echo',
