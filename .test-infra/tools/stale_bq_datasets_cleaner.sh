...
CLEANUP_DATASET_TEMPLATES=( beam_temp_dataset_ file_loads_streaming_it_ FHIR_store_ io_bigquery_lt_ managed-iceberg-biglake-its.biglake_test_catalog_  'managed_iceberg_bqms.*_tests?_' '_(python|java)_validations_' '\:(bq_read_all_|combine_per_key_examples|filter_examples|hourly_team_score_|leader_board_|leaderboard_|game_stats_|python_|temp_dataset)[a-z_]*[0-9a-f]{12,}$')
