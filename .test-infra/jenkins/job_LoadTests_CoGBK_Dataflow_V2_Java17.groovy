  ...
  [
    [
      ...
      pipelineOptions: [
        ...
        bigQueryTable         : "java17_dataflow_v2_${mode}_CoGBK_1",
    ...
    [
      ...
      pipelineOptions: [
        ...
        publishToBigQuery     : true,
        bigQueryDataset       : datasetName,
        bigQueryTable         : "java17_dataflow_v2_${mode}_CoGBK_2",
    ...
    [
      ...
      pipelineOptions: [
        ...
        publishToBigQuery     : true,
        bigQueryDataset       : datasetName,
        bigQueryTable         : "java17_dataflow_v2_${mode}_CoGBK_3",
    ...
    [
      ...
      pipelineOptions: [
        ...
        publishToBigQuery     : true,
        bigQueryDataset       : datasetName,
        bigQueryTable         : "java17_dataflow_v2_${mode}_CoGBK_4",
