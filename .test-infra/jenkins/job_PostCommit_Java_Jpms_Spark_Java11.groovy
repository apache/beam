...
String prTriggerPhrase = "./gradlew :sdks:java:testing:jpms-tests:sparkRunnerIntegrationTest -Dorg.gradle.java.home=${commonJobProperties.JAVA_11_HOME}"

// This job runs the Java postcommit tests, including the suite of integration
// tests.
PostcommitJobBuilder.postCommitJob('beam_PostCommit_Java_Jpms_Spark_Java11',
        prTriggerPhrase,
        "JPMS Java 11 Spark Post Commit Tests ${prTriggerPhrase}", this) {
