...
job('beam_PostRelease_Python2_Candidate_MobileGame_Dataflow') {
    description('Runs mobile game verification of the Python2 release candidate with dataflow runner by using tar and wheel.')
    ...
    steps {
        shell('cd ' + commonJobProperties.checkoutDir +
                ' && bash release/src/main/python-release/python_release_automation.sh 2.7 dataflow mobile_game')
    }
}