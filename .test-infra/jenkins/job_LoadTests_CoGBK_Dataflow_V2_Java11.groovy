...
CronJobBuilder.cronJob('beam_LoadTests_Java_CoGBK_Dataflow_V2_Streaming_Java11', 'H 12 * * *', this) {
...
PhraseTriggeringPostCommitBuilder.postCommitJob(
    'beam_LoadTests_Java_CoGBK_Dataflow_V2_Streaming_Java11',
    'Run Load Tests Java 11 CoGBK Dataflow V2 Streaming',
    'Load Tests Java 11 CoGBK Dataflow V2 Streaming suite',
    this
    ) {
      additionalPipelineArgs = [:]
...
def batchLoadTestJob = { scope, triggeringContext ->
  ...
  loadTestsBuilder.loadTests(scope, CommonTestProperties.SDK.JAVA, loadTestConfigurations('batch', false, datasetName),
      "CoGBK", "batch", JOB_SPECIFIC_SWITCHES, loadTestsBuilder.JAVA_11_RUNTIME_VERSION)
}

CronJobBuilder.cronJob('beam_LoadTests_Java_CoGBK_Dataflow_V2_Batch_Java11', 'H 14 * * *', this) {
  additionalPipelineArgs = [
    influxDatabase: InfluxDBCredentialsHelper.InfluxDBDatabaseName,
    influxHost: InfluxDBCredentialsHelper.InfluxDBHostUrl,
  ]
...
PhraseTriggeringPostCommitBuilder.postCommitJob(
    ...
    'Load Tests Java 11 CoGBK Dataflow V2 Batch suite',
    this
    ) {
      additionalPipelineArgs = [:]
