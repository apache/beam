  ...
  [
    [
      ...
      pipelineOptions: [
        ...
        region                : 'us-central1',
        appName               : "load_tests_Java17_Dataflow_V2_${mode}_GBK_1",
        tempLocation          : 'gs://temp-storage-for-perf-tests/loadtests',
        publishToBigQuery     : true,
        bigQueryDataset       : datasetName,
        bigQueryTable         : "java17_Dataflow_V2_${mode}_GBK_1",
    ...
    [
      ...
      pipelineOptions: [
        project               : 'apache-beam-testing',
        region                : 'us-central1',
        appName               : "load_tests_Java17_Dataflow_V2_${mode}_GBK_2",
        tempLocation          : 'gs://temp-storage-for-perf-tests/loadtests',
        publishToBigQuery     : true,
        bigQueryDataset       : datasetName,
        bigQueryTable         : "java17_dataflow_v2_${mode}_GBK_2",
    ...
    [
      ...
      pipelineOptions: [
        project               : 'apache-beam-testing',
        region                : 'us-central1',
        appName               : "load_tests_Java17_Dataflow_V2_${mode}_GBK_3",
        tempLocation          : 'gs://temp-storage-for-perf-tests/loadtests',
        publishToBigQuery     : true,
        bigQueryDataset       : datasetName,
        bigQueryTable         : "java17_dataflow_v2_${mode}_GBK_3",
    ...
    [
      ...
      pipelineOptions: [
        project               : 'apache-beam-testing',
        region                : 'us-central1',
        appName               : "load_tests_Java17_Dataflow_V2_${mode}_GBK_4",
        tempLocation          : 'gs://temp-storage-for-perf-tests/loadtests',
        publishToBigQuery     : true,
        bigQueryDataset       : datasetName,
        bigQueryTable         : "java17_dataflow_v2_${mode}_GBK_4",
    ...
    [
      ...
      pipelineOptions: [
        project               : 'apache-beam-testing',
        region                : 'us-central1',
        appName               : "load_tests_Java17_Dataflow_V2_${mode}_GBK_5",
        tempLocation          : 'gs://temp-storage-for-perf-tests/loadtests',
        publishToBigQuery     : true,
        bigQueryDataset       : datasetName,
        bigQueryTable         : "java17_dataflow_v2_${mode}_GBK_5",
    ...
    [
      ...
      pipelineOptions: [
        project               : 'apache-beam-testing',
        region                : 'us-central1',
        appName               : "load_tests_Java17_Dataflow_V2_${mode}_GBK_6",
        tempLocation          : 'gs://temp-storage-for-perf-tests/loadtests',
        publishToBigQuery     : true,
        bigQueryDataset       : datasetName,
        bigQueryTable         : "java17_dataflow_v2_${mode}_GBK_6",
    ...
    [
      ...
      pipelineOptions: [
        project               : 'apache-beam-testing',
        region                : 'us-central1',
        appName               : "load_tests_Java17_Dataflow_V2_${mode}_GBK_7",
        tempLocation          : 'gs://temp-storage-for-perf-tests/loadtests',
        publishToBigQuery     : true,
        bigQueryDataset       : datasetName,
        bigQueryTable         : "java17_dataflow_v2_${mode}_GBK_7",
...
def streamingLoadTestJob = { scope, triggeringContext ->
  scope.description('Runs Java 17 GBK load tests on Dataflow runner V2 in streaming mode')
...
PhraseTriggeringPostCommitBuilder.postCommitJob(
    'beam_LoadTests_Java_GBK_Dataflow_V2_Streaming_Java17',
    'Run Load Tests Java 17 GBK Dataflow V2 Streaming',
    'Load Tests Java 17 GBK Dataflow V2 Streaming suite',
    this
    ) {
      additionalPipelineArgs = [:]
...
PhraseTriggeringPostCommitBuilder.postCommitJob(
    ...
    'Run Load Tests Java 17 GBK Dataflow V2 Batch',
    'Load Tests Java 17 GBK Dataflow V2 Batch suite',
    this
    ) {
      additionalPipelineArgs = [:]
