...
pythonPrecommitJob(gradleTask=":pythonPreCommit", nameBase="Python_Examples", commitTriggering=true)
...
pythonPrecommitJob(gradleTask=":pythonPreCommitRC", nameBase="PythonRC_Examples", commitTriggering=false)
