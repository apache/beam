  ...
  [
    [
      ...
      pipelineOptions: [
        ...
        region              : 'us-central1',
        appName             : "load_tests_Java17_Dataflow_V2_${jobType}_ParDo_1",
        tempLocation        : 'gs://temp-storage-for-perf-tests/loadtests',
        publishToBigQuery   : true,
        bigQueryDataset     : datasetName,
        bigQueryTable       : "java17_dataflow_v2_${jobType}_ParDo_1",
    ...
    [
      ...
      pipelineOptions: [
        project             : 'apache-beam-testing',
        region              : 'us-central1',
        appName             : "load_tests_Java17_Dataflow_V2_${jobType}_ParDo_2",
        tempLocation        : 'gs://temp-storage-for-perf-tests/loadtests',
        publishToBigQuery   : true,
        bigQueryDataset     : datasetName,
        bigQueryTable       : "java17_dataflow_v2_${jobType}_ParDo_2",
    ...
    [
      ...
      pipelineOptions: [
        project             : 'apache-beam-testing',
        region              : 'us-central1',
        appName             : "load_tests_Java17_Dataflow_V2_${jobType}_ParDo_3",
        tempLocation        : 'gs://temp-storage-for-perf-tests/loadtests',
        publishToBigQuery   : true,
        bigQueryDataset     : datasetName,
        bigQueryTable       : "java17_dataflow_v2_${jobType}_ParDo_3",
    ...
    [
      ...
      pipelineOptions: [
        project             : 'apache-beam-testing',
        region              : 'us-central1',
        appName             : "load_tests_Java17_Dataflow_V2_${jobType}_ParDo_4",
        tempLocation        : 'gs://temp-storage-for-perf-tests/loadtests',
        publishToBigQuery   : true,
        bigQueryDataset     : datasetName,
        bigQueryTable       : "java17_dataflow_v2_${jobType}_ParDo_4",
...
def streamingLoadTestJob = {scope, triggeringContext ->
  scope.description('Runs Java 17 ParDo load tests on Dataflow runner V2 in streaming mode')
...
CronJobBuilder.cronJob('beam_LoadTests_Java_ParDo_Dataflow_V2_Batch_Java17', 'H 12 * * *', this) {
...
CronJobBuilder.cronJob('beam_LoadTests_Java_ParDo_Dataflow_V2_Streaming_Java17', 'H 12 * * *', this) {
  additionalPipelineArgs = [
    influxDatabase: InfluxDBCredentialsHelper.InfluxDBDatabaseName,
    influxHost: InfluxDBCredentialsHelper.InfluxDBHostUrl,
  ]
...
PhraseTriggeringPostCommitBuilder.postCommitJob(
    'beam_LoadTests_Java_ParDo_Dataflow_V2_Batch_Java17',
    'Run Load Tests Java 17 ParDo Dataflow V2 Batch',
    'Load Tests Java 17 ParDo Dataflow V2 Batch suite',
    this
    ) {
      additionalPipelineArgs = [:]
...
PhraseTriggeringPostCommitBuilder.postCommitJob(
    'beam_LoadTests_Java_ParDo_Dataflow_V2_Streaming_Java17',
    'Run Load Tests Java 17 ParDo Dataflow V2 Streaming',
    'Load Tests Java 17 ParDo Dataflow V2 Streaming suite',
    this
    ) {
      additionalPipelineArgs = [:]
