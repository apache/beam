...
pythonPrecommitJob(gradleTask=":pythonPreCommit", nameBase="Python_Runners", commitTriggering=true)
...
pythonPrecommitJob(gradleTask=":pythonPreCommitRC", nameBase="PythonRC_Runners", commitTriggering=false)
