...
NoPhraseTriggeringPostCommitBuilder.postCommitJob('beam_PostCommit_Java_Nexmark_Spark',
  ...
  new NexmarkJob(delegate, runner, sdk, TriggeringContext.POST_COMMIT).batchOnlyJob(jobSpecificOptions)
}
...
PhraseTriggeringPostCommitBuilder.postCommitJob('beam_PostCommit_Java_Nexmark_Spark',
  ...
  new NexmarkJob(delegate, runner, sdk, TriggeringContext.PR).batchOnlyJob(jobSpecificOptions)
}
